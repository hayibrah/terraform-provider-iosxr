...
func (data LineDefault) GetEnumConstraints() []helpers.FieldEnumConstraint {
	return nil
}
...
func (data LineDefault) GetStringLengthConstraints() []helpers.FieldStringLengthConstraint {
	return nil
}
...
func (data LineDefault) GetPatternConstraints() []helpers.FieldPatternConstraint {
	return nil
}
