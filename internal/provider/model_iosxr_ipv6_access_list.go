...
func (data *IPv6AccessList) updateFromBody(ctx context.Context, res []byte, version string) {
	for i := range data.Sequences {
		...
		if value := r.Get("permit.headers"); value.Exists() && value.Type == gjson.String && !data.Sequences[i].PermitHeaders.IsNull() {
		...
		if value := r.Get("permit.nexthop1.ipv6"); value.Exists() && value.Type == gjson.String && !data.Sequences[i].PermitNexthop1Ipv6.IsNull() {
		...
		if value := r.Get("permit.nexthop2.ipv6"); value.Exists() && value.Type == gjson.String && !data.Sequences[i].PermitNexthop2Ipv6.IsNull() {
		...
		if value := r.Get("permit.nexthop3.ipv6"); value.Exists() && value.Type == gjson.String && !data.Sequences[i].PermitNexthop3Ipv6.IsNull() {
		...
		if value := r.Get("deny.headers"); value.Exists() && value.Type == gjson.String && !data.Sequences[i].DenyHeaders.IsNull() {
...
func (data *IPv6AccessList) fromBody(ctx context.Context, res []byte, version string) {
	if value := gjson.GetBytes(res, "sequences.sequence"); value.Exists() {
		...
		value.ForEach(func(k, v gjson.Result) bool {
			...
			if cValue := v.Get("permit.headers"); cValue.Exists() && cValue.Type == gjson.String {
			...
			if cValue := v.Get("permit.nexthop1.ipv6"); cValue.Exists() && cValue.Type == gjson.String {
			...
			if cValue := v.Get("permit.nexthop2.ipv6"); cValue.Exists() && cValue.Type == gjson.String {
			...
			if cValue := v.Get("permit.nexthop3.ipv6"); cValue.Exists() && cValue.Type == gjson.String {
			...
			if cValue := v.Get("deny.headers"); cValue.Exists() && cValue.Type == gjson.String {
