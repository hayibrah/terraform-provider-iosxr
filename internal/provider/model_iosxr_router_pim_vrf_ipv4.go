...
func (data *RouterPIMVRFIPv4) updateFromBody(ctx context.Context, res []byte, version string) {
	...
	if value := gjson.GetBytes(res, "maximum.bsr.crp-cache.maximum-crp-cache"); value.Exists() && value.Type == gjson.Number && !data.MaximumBsrCrpCache.IsNull() {
...
func (data *RouterPIMVRFIPv4) getEmptyLeafsDelete(ctx context.Context, version string) []string {
