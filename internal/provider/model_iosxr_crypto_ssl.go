...
func (data CryptoSSL) GetEnumConstraints() []helpers.FieldEnumConstraint {
	return nil
}
...
func (data CryptoSSL) GetStringLengthConstraints() []helpers.FieldStringLengthConstraint {
	return nil
}
...
func (data CryptoSSL) GetPatternConstraints() []helpers.FieldPatternConstraint {
	return nil
}
...
func (data *CryptoSSL) updateFromBody(ctx context.Context, res []byte, version string) {
	for i := range data.Profile {
		...
		if value := r.Get("certificate"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.Profile[i].Certificate.IsNull() {
...
func (data *CryptoSSL) fromBody(ctx context.Context, res []byte, version string) {
	if value := gjson.GetBytes(res, "profiles.profile"); value.Exists() {
		...
		value.ForEach(func(k, v gjson.Result) bool {
			...
			if cValue := v.Get("certificate"); cValue.Exists() && (cValue.Type == gjson.String || cValue.Type == gjson.Number) {
