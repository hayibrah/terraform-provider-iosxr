...
func (data RouterStaticVRFIPv4Multicast) GetEnumConstraints() []helpers.FieldEnumConstraint {
	return nil
}
...
func (data RouterStaticVRFIPv4Multicast) GetStringLengthConstraints() []helpers.FieldStringLengthConstraint {
	return nil
}
...
func (data RouterStaticVRFIPv4Multicast) GetPatternConstraints() []helpers.FieldPatternConstraint {
	return nil
}
...
func (data *RouterStaticVRFIPv4Multicast) updateFromBody(ctx context.Context, res []byte, version string) {
...
func (data *RouterStaticVRFIPv4Multicast) fromBody(ctx context.Context, res []byte, version string) {
...
func (data *RouterStaticVRFIPv4MulticastData) fromBody(ctx context.Context, res []byte, version string) {
	if value := gjson.GetBytes(res, "nexthop-interfaces.nexthop-interface"); value.Exists() {
		data.NexthopInterfaces = make([]RouterStaticVRFIPv4MulticastNexthopInterfaces, 0)
		value.ForEach(func(k, v gjson.Result) bool {
			item := RouterStaticVRFIPv4MulticastNexthopInterfaces{}
...
func (data *RouterStaticVRFIPv4Multicast) getDeletedItems(ctx context.Context, state RouterStaticVRFIPv4Multicast, version string) []string {
...
func (data *RouterStaticVRFIPv4Multicast) getEmptyLeafsDelete(ctx context.Context, version string) []string {
...
func (data *RouterStaticVRFIPv4Multicast) getDeletePaths(ctx context.Context, version string) []string {
