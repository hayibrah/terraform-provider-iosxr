...
func TestAccIosxrLogging(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_logging.test",
	...
	if iosxrVersionAtLeast(os.Getenv("IOSXR_VERSION"), "25.4") {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_logging.test", "console_discriminator_match1", "CONSOLE1"))
	}
	if iosxrVersionAtLeast(os.Getenv("IOSXR_VERSION"), "25.4") {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_logging.test", "console_discriminator_match2", "CONSOLE2"))
	}
	if iosxrVersionAtLeast(os.Getenv("IOSXR_VERSION"), "25.4") {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_logging.test", "console_discriminator_match3", "CONSOLE3"))
	}
	if iosxrVersionAtLeast(os.Getenv("IOSXR_VERSION"), "25.4") {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_logging.test", "console_discriminator_nomatch1", "CONSOLE_NOMATCH1"))
	}
	if iosxrVersionAtLeast(os.Getenv("IOSXR_VERSION"), "25.4") {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_logging.test", "console_discriminator_nomatch2", "CONSOLE_NOMATCH2"))
	}
	if iosxrVersionAtLeast(os.Getenv("IOSXR_VERSION"), "25.4") {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_logging.test", "console_discriminator_nomatch3", "CONSOLE_NOMATCH3"))
	}
	if iosxrVersionAtLeast(os.Getenv("IOSXR_VERSION"), "25.4") {
	...
	if iosxrVersionAtLeast(os.Getenv("IOSXR_VERSION"), "25.4") {
		...
		if iosxrVersionAtLeast(os.Getenv("IOSXR_VERSION"), "25.4") {
			checks = append(checks, resource.TestCheckResourceAttr("iosxr_logging.test", "tls_servers.0.vrf", "VRF1"))
		}
		if iosxrVersionAtLeast(os.Getenv("IOSXR_VERSION"), "25.4") {
