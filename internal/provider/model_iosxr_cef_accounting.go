...
func (data CEFAccounting) GetStringLengthConstraints() []helpers.FieldStringLengthConstraint {
	return nil
}
...
func (data CEFAccounting) GetPatternConstraints() []helpers.FieldPatternConstraint {
	return nil
}
