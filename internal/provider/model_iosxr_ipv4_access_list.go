		...
		for j := range data.Sequences {
			...
			if found {
				...
				if !state.Sequences[i].DenyNexthop3Vrf.IsNull() && data.Sequences[j].DenyNexthop3Vrf.IsNull() {
					deletedItems = append(deletedItems, path.Join(fmt.Sprintf("%v/sequences/sequence%v", state.getPath(), keyString), "deny/nexthop3/vrf"))
				}
				if !state.Sequences[i].DenyNexthop3Track.IsNull() && data.Sequences[j].DenyNexthop3Track.IsNull() {
					deletedItems = append(deletedItems, path.Join(fmt.Sprintf("%v/sequences/sequence%v", state.getPath(), keyString), "deny/nexthop3/track"))
				}
				if !state.Sequences[i].DenyNexthop3Ipv4.IsNull() && data.Sequences[j].DenyNexthop3Ipv4.IsNull() {
					deletedItems = append(deletedItems, path.Join(fmt.Sprintf("%v/sequences/sequence%v", state.getPath(), keyString), "deny/nexthop3/ipv4"))
				}
				if !state.Sequences[i].DenyNexthop2Vrf.IsNull() && data.Sequences[j].DenyNexthop2Vrf.IsNull() {
					deletedItems = append(deletedItems, path.Join(fmt.Sprintf("%v/sequences/sequence%v", state.getPath(), keyString), "deny/nexthop2/vrf"))
				}
				if !state.Sequences[i].DenyNexthop2Track.IsNull() && data.Sequences[j].DenyNexthop2Track.IsNull() {
					deletedItems = append(deletedItems, path.Join(fmt.Sprintf("%v/sequences/sequence%v", state.getPath(), keyString), "deny/nexthop2/track"))
				}
				if !state.Sequences[i].DenyNexthop2Ipv4.IsNull() && data.Sequences[j].DenyNexthop2Ipv4.IsNull() {
					deletedItems = append(deletedItems, path.Join(fmt.Sprintf("%v/sequences/sequence%v", state.getPath(), keyString), "deny/nexthop2/ipv4"))
				}
				if !state.Sequences[i].DenyNexthop1Vrf.IsNull() && data.Sequences[j].DenyNexthop1Vrf.IsNull() {
					deletedItems = append(deletedItems, path.Join(fmt.Sprintf("%v/sequences/sequence%v", state.getPath(), keyString), "deny/nexthop1/vrf"))
				}
				if !state.Sequences[i].DenyNexthop1Track.IsNull() && data.Sequences[j].DenyNexthop1Track.IsNull() {
					deletedItems = append(deletedItems, path.Join(fmt.Sprintf("%v/sequences/sequence%v", state.getPath(), keyString), "deny/nexthop1/track"))
				}
				if !state.Sequences[i].DenyNexthop1Ipv4.IsNull() && data.Sequences[j].DenyNexthop1Ipv4.IsNull() {
					deletedItems = append(deletedItems, path.Join(fmt.Sprintf("%v/sequences/sequence%v", state.getPath(), keyString), "deny/nexthop1/ipv4"))
				}
				if !state.Sequences[i].DenyDefault.IsNull() && data.Sequences[j].DenyDefault.IsNull() {
					deletedItems = append(deletedItems, path.Join(fmt.Sprintf("%v/sequences/sequence%v", state.getPath(), keyString), "deny/default"))
				}
				...
				if !state.Sequences[i].DenyFragments.IsNull() && data.Sequences[j].DenyFragments.IsNull() {
					deletedItems = append(deletedItems, path.Join(fmt.Sprintf("%v/sequences/sequence%v", state.getPath(), keyString), "deny/fragments"))
				}
				if !state.Sequences[i].DenyFragmentOffsetRangeEnd.IsNull() && data.Sequences[j].DenyFragmentOffsetRangeEnd.IsNull() {
					deletedItems = append(deletedItems, path.Join(fmt.Sprintf("%v/sequences/sequence%v", state.getPath(), keyString), "deny/fragment-offset/range/end-value"))
				}
				if !state.Sequences[i].DenyFragmentOffsetRangeStart.IsNull() && data.Sequences[j].DenyFragmentOffsetRangeStart.IsNull() {
					deletedItems = append(deletedItems, path.Join(fmt.Sprintf("%v/sequences/sequence%v", state.getPath(), keyString), "deny/fragment-offset/range/start-value"))
				}
				if !state.Sequences[i].DenyFragmentOffsetNeq.IsNull() && data.Sequences[j].DenyFragmentOffsetNeq.IsNull() {
					deletedItems = append(deletedItems, path.Join(fmt.Sprintf("%v/sequences/sequence%v", state.getPath(), keyString), "deny/fragment-offset/neq"))
				}
				if !state.Sequences[i].DenyFragmentOffsetLt.IsNull() && data.Sequences[j].DenyFragmentOffsetLt.IsNull() {
					deletedItems = append(deletedItems, path.Join(fmt.Sprintf("%v/sequences/sequence%v", state.getPath(), keyString), "deny/fragment-offset/lt"))
				}
				if !state.Sequences[i].DenyFragmentOffsetGt.IsNull() && data.Sequences[j].DenyFragmentOffsetGt.IsNull() {
					deletedItems = append(deletedItems, path.Join(fmt.Sprintf("%v/sequences/sequence%v", state.getPath(), keyString), "deny/fragment-offset/gt"))
				}
				if !state.Sequences[i].DenyFragmentOffsetEq.IsNull() && data.Sequences[j].DenyFragmentOffsetEq.IsNull() {
					deletedItems = append(deletedItems, path.Join(fmt.Sprintf("%v/sequences/sequence%v", state.getPath(), keyString), "deny/fragment-offset/eq"))
				}
				...
				if !state.Sequences[i].DenyIgmpType.IsNull() && data.Sequences[j].DenyIgmpType.IsNull() {
					deletedItems = append(deletedItems, path.Join(fmt.Sprintf("%v/sequences/sequence%v", state.getPath(), keyString), "deny/igmp-type"))
				}
				...
				if !state.Sequences[i].PermitNexthop3Ipv4.IsNull() && data.Sequences[j].PermitNexthop3Ipv4.IsNull() {
					deletedItems = append(deletedItems, path.Join(fmt.Sprintf("%v/sequences/sequence%v", state.getPath(), keyString), "permit/nexthop3/ipv4"))
				}
				...
				if !state.Sequences[i].PermitNexthop2Ipv4.IsNull() && data.Sequences[j].PermitNexthop2Ipv4.IsNull() {
					deletedItems = append(deletedItems, path.Join(fmt.Sprintf("%v/sequences/sequence%v", state.getPath(), keyString), "permit/nexthop2/ipv4"))
				}
				...
				if !state.Sequences[i].PermitNexthop1Ipv4.IsNull() && data.Sequences[j].PermitNexthop1Ipv4.IsNull() {
					deletedItems = append(deletedItems, path.Join(fmt.Sprintf("%v/sequences/sequence%v", state.getPath(), keyString), "permit/nexthop1/ipv4"))
				}
				if !state.Sequences[i].PermitDefault.IsNull() && data.Sequences[j].PermitDefault.IsNull() {
					deletedItems = append(deletedItems, path.Join(fmt.Sprintf("%v/sequences/sequence%v", state.getPath(), keyString), "permit/default"))
				}
				...
				if !state.Sequences[i].PermitFragments.IsNull() && data.Sequences[j].PermitFragments.IsNull() {
					deletedItems = append(deletedItems, path.Join(fmt.Sprintf("%v/sequences/sequence%v", state.getPath(), keyString), "permit/fragments"))
				}
				if !state.Sequences[i].PermitFragmentOffsetRangeEnd.IsNull() && data.Sequences[j].PermitFragmentOffsetRangeEnd.IsNull() {
					deletedItems = append(deletedItems, path.Join(fmt.Sprintf("%v/sequences/sequence%v", state.getPath(), keyString), "permit/fragment-offset/range/end-value"))
				}
				if !state.Sequences[i].PermitFragmentOffsetRangeStart.IsNull() && data.Sequences[j].PermitFragmentOffsetRangeStart.IsNull() {
					deletedItems = append(deletedItems, path.Join(fmt.Sprintf("%v/sequences/sequence%v", state.getPath(), keyString), "permit/fragment-offset/range/start-value"))
				}
				if !state.Sequences[i].PermitFragmentOffsetNeq.IsNull() && data.Sequences[j].PermitFragmentOffsetNeq.IsNull() {
					deletedItems = append(deletedItems, path.Join(fmt.Sprintf("%v/sequences/sequence%v", state.getPath(), keyString), "permit/fragment-offset/neq"))
				}
				if !state.Sequences[i].PermitFragmentOffsetLt.IsNull() && data.Sequences[j].PermitFragmentOffsetLt.IsNull() {
					deletedItems = append(deletedItems, path.Join(fmt.Sprintf("%v/sequences/sequence%v", state.getPath(), keyString), "permit/fragment-offset/lt"))
				}
				if !state.Sequences[i].PermitFragmentOffsetGt.IsNull() && data.Sequences[j].PermitFragmentOffsetGt.IsNull() {
					deletedItems = append(deletedItems, path.Join(fmt.Sprintf("%v/sequences/sequence%v", state.getPath(), keyString), "permit/fragment-offset/gt"))
				}
				if !state.Sequences[i].PermitFragmentOffsetEq.IsNull() && data.Sequences[j].PermitFragmentOffsetEq.IsNull() {
					deletedItems = append(deletedItems, path.Join(fmt.Sprintf("%v/sequences/sequence%v", state.getPath(), keyString), "permit/fragment-offset/eq"))
				}
				...
				if !state.Sequences[i].PermitIgmpType.IsNull() && data.Sequences[j].PermitIgmpType.IsNull() {
					deletedItems = append(deletedItems, path.Join(fmt.Sprintf("%v/sequences/sequence%v", state.getPath(), keyString), "permit/igmp-type"))
				}
...
func (data *IPv4AccessList) getEmptyLeafsDelete(ctx context.Context, version string) []string {
	...
	for i := range data.Sequences {
		...
		if !data.Sequences[i].DenyDefault.IsNull() && !data.Sequences[i].DenyDefault.ValueBool() {
			emptyLeafsDelete = append(emptyLeafsDelete, path.Join(fmt.Sprintf("%v/sequences/sequence%v", data.getPath(), keyString), "deny/default"))
		}
		if !data.Sequences[i].DenyFragments.IsNull() && !data.Sequences[i].DenyFragments.ValueBool() {
			emptyLeafsDelete = append(emptyLeafsDelete, path.Join(fmt.Sprintf("%v/sequences/sequence%v", data.getPath(), keyString), "deny/fragments"))
		}
		...
		if !data.Sequences[i].PermitDefault.IsNull() && !data.Sequences[i].PermitDefault.ValueBool() {
			emptyLeafsDelete = append(emptyLeafsDelete, path.Join(fmt.Sprintf("%v/sequences/sequence%v", data.getPath(), keyString), "permit/default"))
		}
		if !data.Sequences[i].PermitFragments.IsNull() && !data.Sequences[i].PermitFragments.ValueBool() {
			emptyLeafsDelete = append(emptyLeafsDelete, path.Join(fmt.Sprintf("%v/sequences/sequence%v", data.getPath(), keyString), "permit/fragments"))
		}
