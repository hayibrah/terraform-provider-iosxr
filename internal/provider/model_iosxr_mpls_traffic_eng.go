...
func (data MPLSTrafficEng) GetEnumConstraints() []helpers.FieldEnumConstraint {
	return nil
}
...
func (data MPLSTrafficEng) GetStringLengthConstraints() []helpers.FieldStringLengthConstraint {
	return nil
}
...
func (data MPLSTrafficEng) GetPatternConstraints() []helpers.FieldPatternConstraint {
	return nil
}
