...
func (data InterfaceEthernetSubinterface) GetEnumConstraints() []helpers.FieldEnumConstraint {
	return nil
}
...
func (data InterfaceEthernetSubinterface) GetStringLengthConstraints() []helpers.FieldStringLengthConstraint {
	return nil
}
...
func (data InterfaceEthernetSubinterface) GetPatternConstraints() []helpers.FieldPatternConstraint {
	return nil
}
...
func (data *InterfaceEthernetSubinterface) getDeletedItems(ctx context.Context, state InterfaceEthernetSubinterface, version string) []string {
	...
	if !state.L2transport.IsNull() && data.L2transport.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "sub-interface-type/l2transport"))
	}
	return deletedItems
}
...
func (data *InterfaceEthernetSubinterface) getDeletePaths(ctx context.Context, version string) []string {
	...
	if !data.L2transport.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "sub-interface-type/l2transport"))
	}
	return deletePaths
}
