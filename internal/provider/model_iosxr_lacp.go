...
func (data LACP) GetEnumConstraints() []helpers.FieldEnumConstraint {
	return nil
}
...
func (data LACP) GetStringLengthConstraints() []helpers.FieldStringLengthConstraint {
	return nil
}
...
func (data LACP) GetPatternConstraints() []helpers.FieldPatternConstraint {
	return nil
}
...
func (data *LACP) getEmptyLeafsDelete(ctx context.Context, version string) []string {
