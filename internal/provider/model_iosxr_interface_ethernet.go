...
func (data InterfaceEthernet) GetEnumConstraints() []helpers.FieldEnumConstraint {
	return nil
}
...
func (data InterfaceEthernet) GetStringLengthConstraints() []helpers.FieldStringLengthConstraint {
	return nil
}
...
func (data InterfaceEthernet) GetPatternConstraints() []helpers.FieldPatternConstraint {
	return nil
}
...
func (data *InterfaceEthernet) updateFromBody(ctx context.Context, res []byte, version string) {
	...
	if value := gjson.GetBytes(res, "dampening.decay-half-life.reuse-threshold.suppress-threshold.max-suppress-time.restart-penalty.value"); value.Exists() && value.Type == gjson.Number && !data.DampeningRestartPenalty.IsNull() {
	...
	for i := range data.ServicePolicyInput {
		...
		if value := r.Get("service-policy-name"); value.Exists() && value.Type == gjson.String && !data.ServicePolicyInput[i].Name.IsNull() {
	...
	for i := range data.ServicePolicyOutput {
		...
		if value := r.Get("service-policy-name"); value.Exists() && value.Type == gjson.String && !data.ServicePolicyOutput[i].Name.IsNull() {
			data.ServicePolicyOutput[i].Name = types.StringValue(value.String())
		} else {
			data.ServicePolicyOutput[i].Name = types.StringNull()
		}
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-l2-ethernet-cfg:encapsulation.dot1q.vlan-id"); value.Exists() && value.Type == gjson.Number && !data.EncapsulationDot1qVlanId.IsNull() {
		data.EncapsulationDot1qVlanId = types.Int64Value(value.Int())
	} else {
		data.EncapsulationDot1qVlanId = types.Int64Null()
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-l2-ethernet-cfg:encapsulation.dot1q.second-dot1q"); value.Exists() && value.Type == gjson.Number && !data.EncapsulationDot1qSecondDot1q.IsNull() {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-l2-ethernet-cfg:l2transport-encapsulation.dot1q.vlan-id"); value.Exists() && value.Type == gjson.String && !data.L2transportEncapsulationDot1qVlanId.IsNull() {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-l2-ethernet-cfg:l2transport-encapsulation.dot1q.second-dot1q"); value.Exists() && value.Type == gjson.String && !data.L2transportEncapsulationDot1qSecondDot1q.IsNull() {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-vrf-cfg:vrf"); value.Exists() && value.Type == gjson.String && !data.Vrf.IsNull() {
		data.Vrf = types.StringValue(value.String())
	} else {
		data.Vrf = types.StringNull()
	}
	if value := gjson.GetBytes(res, "ipv4.Cisco-IOS-XR-um-if-ip-address-cfg:addresses.address.address"); value.Exists() && value.Type == gjson.String && !data.Ipv4Address.IsNull() {
		data.Ipv4Address = types.StringValue(value.String())
	} else {
		data.Ipv4Address = types.StringNull()
	}
	if value := gjson.GetBytes(res, "ipv4.Cisco-IOS-XR-um-if-ip-address-cfg:addresses.address.netmask"); value.Exists() && value.Type == gjson.String && !data.Ipv4Netmask.IsNull() {
	...
	for i := range data.Ipv4Secondaries {
		...
		if value := r.Get("address"); value.Exists() && value.Type == gjson.String && !data.Ipv4Secondaries[i].Address.IsNull() {
			data.Ipv4Secondaries[i].Address = types.StringValue(value.String())
		} else {
			data.Ipv4Secondaries[i].Address = types.StringNull()
		}
		if value := r.Get("netmask"); value.Exists() && value.Type == gjson.String && !data.Ipv4Secondaries[i].Netmask.IsNull() {
	...
	if value := gjson.GetBytes(res, "ipv4.Cisco-IOS-XR-um-if-ip-address-cfg:addresses.unnumbered"); value.Exists() && value.Type == gjson.String && !data.Ipv4Unnumbered.IsNull() {
	...
	for i := range data.Ipv4HelperAddresses {
		...
		if value := r.Get("address"); value.Exists() && value.Type == gjson.String && !data.Ipv4HelperAddresses[i].Address.IsNull() {
			data.Ipv4HelperAddresses[i].Address = types.StringValue(value.String())
		} else {
			data.Ipv4HelperAddresses[i].Address = types.StringNull()
		}
		if value := r.Get("vrf"); value.Exists() && value.Type == gjson.String && !data.Ipv4HelperAddresses[i].Vrf.IsNull() {
	...
	if value := gjson.GetBytes(res, "ipv4.Cisco-IOS-XR-um-if-ipv4-cfg:verify.unicast.source.reachable-via.type"); value.Exists() && value.Type == gjson.String && !data.Ipv4VerifyUnicastSourceReachableViaType.IsNull() {
	...
	if value := gjson.GetBytes(res, "ipv4.Cisco-IOS-XR-um-if-access-group-cfg:access-group.ingress.access-list-name-1.name"); value.Exists() && value.Type == gjson.String && !data.Ipv4AccessGroupIngressAcl1.IsNull() {
	...
	if value := gjson.GetBytes(res, "ipv4.Cisco-IOS-XR-um-if-access-group-cfg:access-group.ingress.compress"); value.Exists() && value.Type == gjson.Number && !data.Ipv4AccessGroupIngressCompress.IsNull() {
		data.Ipv4AccessGroupIngressCompress = types.Int64Value(value.Int())
	} else {
		data.Ipv4AccessGroupIngressCompress = types.Int64Null()
	}
	if value := gjson.GetBytes(res, "ipv4.Cisco-IOS-XR-um-if-access-group-cfg:access-group.egress.access-list-name.name"); value.Exists() && value.Type == gjson.String && !data.Ipv4AccessGroupEgressAcl.IsNull() {
	...
	if value := gjson.GetBytes(res, "ipv4.Cisco-IOS-XR-um-if-access-group-cfg:access-group.egress.compress"); value.Exists() && value.Type == gjson.Number && !data.Ipv4AccessGroupEgressCompress.IsNull() {
		data.Ipv4AccessGroupEgressCompress = types.Int64Value(value.Int())
	} else {
		data.Ipv4AccessGroupEgressCompress = types.Int64Null()
	}
	if value := gjson.GetBytes(res, "ipv6.Cisco-IOS-XR-um-if-ipv6-cfg:verify.unicast.source.reachable-via.type"); value.Exists() && value.Type == gjson.String && !data.Ipv6VerifyUnicastSourceReachableViaType.IsNull() {
	...
	if value := gjson.GetBytes(res, "ipv6.Cisco-IOS-XR-um-if-access-group-cfg:access-group.ingress.access-list-name-1.name"); value.Exists() && value.Type == gjson.String && !data.Ipv6AccessGroupIngressAcl1.IsNull() {
	...
	if value := gjson.GetBytes(res, "ipv6.Cisco-IOS-XR-um-if-access-group-cfg:access-group.ingress.compress"); value.Exists() && value.Type == gjson.Number && !data.Ipv6AccessGroupIngressCompress.IsNull() {
		data.Ipv6AccessGroupIngressCompress = types.Int64Value(value.Int())
	} else {
		data.Ipv6AccessGroupIngressCompress = types.Int64Null()
	}
	if value := gjson.GetBytes(res, "ipv6.Cisco-IOS-XR-um-if-access-group-cfg:access-group.egress.access-list-name.name"); value.Exists() && value.Type == gjson.String && !data.Ipv6AccessGroupEgressAcl.IsNull() {
	...
	if value := gjson.GetBytes(res, "ipv6.Cisco-IOS-XR-um-if-access-group-cfg:access-group.egress.compress"); value.Exists() && value.Type == gjson.Number && !data.Ipv6AccessGroupEgressCompress.IsNull() {
	...
	for i := range data.Ipv6Addresses {
		...
		if value := r.Get("address"); value.Exists() && value.Type == gjson.String && !data.Ipv6Addresses[i].Address.IsNull() {
		...
		if value := r.Get("zone"); value.Exists() && value.Type == gjson.String && !data.Ipv6Addresses[i].Zone.IsNull() {
	...
	if value := gjson.GetBytes(res, "ipv6.Cisco-IOS-XR-um-if-ip-address-cfg:addresses.link-local-address.address"); value.Exists() && value.Type == gjson.String && !data.Ipv6LinkLocalAddress.IsNull() {
		data.Ipv6LinkLocalAddress = types.StringValue(value.String())
	} else {
		data.Ipv6LinkLocalAddress = types.StringNull()
	}
	if value := gjson.GetBytes(res, "ipv6.Cisco-IOS-XR-um-if-ip-address-cfg:addresses.link-local-address.zone"); value.Exists() && value.Type == gjson.String && !data.Ipv6LinkLocalZone.IsNull() {
	...
	for i := range data.Ipv6Eui64Addresses {
		...
		if value := r.Get("address"); value.Exists() && value.Type == gjson.String && !data.Ipv6Eui64Addresses[i].Address.IsNull() {
		...
		if value := r.Get("zone"); value.Exists() && value.Type == gjson.String && !data.Ipv6Eui64Addresses[i].Zone.IsNull() {
	...
	if value := gjson.GetBytes(res, "ipv6.Cisco-IOS-XR-um-ipv6-nd-cfg:nd.reachable-time"); value.Exists() && value.Type == gjson.Number && !data.Ipv6NdReachableTime.IsNull() {
	...
	if value := gjson.GetBytes(res, "ipv6.Cisco-IOS-XR-um-ipv6-nd-cfg:nd.dad.attempts"); value.Exists() && value.Type == gjson.Number && !data.Ipv6NdDadAttempts.IsNull() {
	...
	if value := gjson.GetBytes(res, "ipv6.Cisco-IOS-XR-um-ipv6-nd-cfg:nd.ns-interval"); value.Exists() && value.Type == gjson.Number && !data.Ipv6NdNsInterval.IsNull() {
		data.Ipv6NdNsInterval = types.Int64Value(value.Int())
	} else {
		data.Ipv6NdNsInterval = types.Int64Null()
	}
	if value := gjson.GetBytes(res, "ipv6.Cisco-IOS-XR-um-ipv6-nd-cfg:nd.ra-interval.maximum-ra-interval"); value.Exists() && value.Type == gjson.Number && !data.Ipv6NdRaIntervalMax.IsNull() {
		data.Ipv6NdRaIntervalMax = types.Int64Value(value.Int())
	} else {
		data.Ipv6NdRaIntervalMax = types.Int64Null()
	}
	if value := gjson.GetBytes(res, "ipv6.Cisco-IOS-XR-um-ipv6-nd-cfg:nd.ra-interval.minimum-ra-interval"); value.Exists() && value.Type == gjson.Number && !data.Ipv6NdRaIntervalMin.IsNull() {
		data.Ipv6NdRaIntervalMin = types.Int64Value(value.Int())
	} else {
		data.Ipv6NdRaIntervalMin = types.Int64Null()
	}
	if value := gjson.GetBytes(res, "ipv6.Cisco-IOS-XR-um-ipv6-nd-cfg:nd.ra-lifetime"); value.Exists() && value.Type == gjson.Number && !data.Ipv6NdRaLifetime.IsNull() {
	...
	for i := range data.EthernetCfmMepDomains {
		...
		if value := r.Get("domain-name"); value.Exists() && value.Type == gjson.String && !data.EthernetCfmMepDomains[i].DomainName.IsNull() {
		...
		if value := r.Get("service"); value.Exists() && value.Type == gjson.String && !data.EthernetCfmMepDomains[i].Service.IsNull() {
			data.EthernetCfmMepDomains[i].Service = types.StringValue(value.String())
		} else {
			data.EthernetCfmMepDomains[i].Service = types.StringNull()
		}
		if value := r.Get("mep-id"); value.Exists() && value.Type == gjson.Number && !data.EthernetCfmMepDomains[i].MepId.IsNull() {
		...
		if value := r.Get("cos"); value.Exists() && value.Type == gjson.Number && !data.EthernetCfmMepDomains[i].Cos.IsNull() {
		...
		if value := r.Get("loss-measurement.counters.priority.cos-range.start-of-cos-range"); value.Exists() && value.Type == gjson.Number && !data.EthernetCfmMepDomains[i].LossMeasurementCountersPriorityCosRangeStart.IsNull() {
		...
		if value := r.Get("loss-measurement.counters.priority.cos-range.end-of-cos-range"); value.Exists() && value.Type == gjson.Number && !data.EthernetCfmMepDomains[i].LossMeasurementCountersPriorityCosRangeEnd.IsNull() {
		...
		if value := r.Get("loss-measurement.counters.priority.cos-values.cos-value1"); value.Exists() && value.Type == gjson.Number && !data.EthernetCfmMepDomains[i].LossMeasurementCountersPriorityCosValue1.IsNull() {
		...
		if value := r.Get("loss-measurement.counters.priority.cos-values.cos-value2"); value.Exists() && value.Type == gjson.Number && !data.EthernetCfmMepDomains[i].LossMeasurementCountersPriorityCosValue2.IsNull() {
		...
		if value := r.Get("loss-measurement.counters.priority.cos-values.cos-value3"); value.Exists() && value.Type == gjson.Number && !data.EthernetCfmMepDomains[i].LossMeasurementCountersPriorityCosValue3.IsNull() {
		...
		if value := r.Get("loss-measurement.counters.priority.cos-values.cos-value4"); value.Exists() && value.Type == gjson.Number && !data.EthernetCfmMepDomains[i].LossMeasurementCountersPriorityCosValue4.IsNull() {
		...
		if value := r.Get("loss-measurement.counters.priority.cos-values.cos-value5"); value.Exists() && value.Type == gjson.Number && !data.EthernetCfmMepDomains[i].LossMeasurementCountersPriorityCosValue5.IsNull() {
		...
		if value := r.Get("loss-measurement.counters.priority.cos-values.cos-value6"); value.Exists() && value.Type == gjson.Number && !data.EthernetCfmMepDomains[i].LossMeasurementCountersPriorityCosValue6.IsNull() {
		...
		if value := r.Get("loss-measurement.counters.priority.cos-values.cos-value7"); value.Exists() && value.Type == gjson.Number && !data.EthernetCfmMepDomains[i].LossMeasurementCountersPriorityCosValue7.IsNull() {
		...
		for ci := range data.EthernetCfmMepDomains[i].SlaOperationProfileTargetMepIds {
			...
			if value := cr.Get("profile-name"); value.Exists() && value.Type == gjson.String && !data.EthernetCfmMepDomains[i].SlaOperationProfileTargetMepIds[ci].ProfileName.IsNull() {
			...
			if value := cr.Get("mep-id"); value.Exists() && value.Type == gjson.Number && !data.EthernetCfmMepDomains[i].SlaOperationProfileTargetMepIds[ci].MepId.IsNull() {
		...
		for ci := range data.EthernetCfmMepDomains[i].SlaOperationProfileTargetMacAddresses {
			...
			if value := cr.Get("profile-name"); value.Exists() && value.Type == gjson.String && !data.EthernetCfmMepDomains[i].SlaOperationProfileTargetMacAddresses[ci].ProfileName.IsNull() {
			...
			if value := cr.Get("mac-address"); value.Exists() && value.Type == gjson.String && !data.EthernetCfmMepDomains[i].SlaOperationProfileTargetMacAddresses[ci].MacAddress.IsNull() {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ethernet-cfm-cfg:ethernet.cfm.ais.transmission.up.interval"); value.Exists() && value.Type == gjson.String && !data.EthernetCfmAisTransmissionUpInterval.IsNull() {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ethernet-cfm-cfg:ethernet.cfm.ais.transmission.up.cos"); value.Exists() && value.Type == gjson.Number && !data.EthernetCfmAisTransmissionUpCos.IsNull() {
		data.EthernetCfmAisTransmissionUpCos = types.Int64Value(value.Int())
	} else {
		data.EthernetCfmAisTransmissionUpCos = types.Int64Null()
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ethernet-cfm-cfg:ethernet.cfm.bandwidth-notifications.hold-off"); value.Exists() && value.Type == gjson.Number && !data.EthernetCfmBandwidthNotificationsHoldOff.IsNull() {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ethernet-cfm-cfg:ethernet.cfm.bandwidth-notifications.wait-to-restore"); value.Exists() && value.Type == gjson.Number && !data.EthernetCfmBandwidthNotificationsWaitToRestore.IsNull() {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ethernet-cfm-cfg:ethernet.cfm.bandwidth-notifications.loss-threshold"); value.Exists() && value.Type == gjson.Number && !data.EthernetCfmBandwidthNotificationsLossThreshold.IsNull() {
	...
	for i := range data.FlowIpv4IngressMonitors {
		...
		if value := r.Get("monitor-map-name"); value.Exists() && value.Type == gjson.String && !data.FlowIpv4IngressMonitors[i].MonitorMapName.IsNull() {
	...
	for i := range data.FlowIpv4IngressMonitorSamplers {
		...
		if value := r.Get("monitor-map-name"); value.Exists() && value.Type == gjson.String && !data.FlowIpv4IngressMonitorSamplers[i].MonitorMapName.IsNull() {
		...
		if value := r.Get("sampler-map-name"); value.Exists() && value.Type == gjson.String && !data.FlowIpv4IngressMonitorSamplers[i].SamplerMapName.IsNull() {
	...
	for i := range data.FlowIpv4EgressMonitors {
		...
		if value := r.Get("monitor-map-name"); value.Exists() && value.Type == gjson.String && !data.FlowIpv4EgressMonitors[i].MonitorMapName.IsNull() {
	...
	for i := range data.FlowIpv4EgressMonitorSamplers {
		...
		if value := r.Get("monitor-map-name"); value.Exists() && value.Type == gjson.String && !data.FlowIpv4EgressMonitorSamplers[i].MonitorMapName.IsNull() {
		...
		if value := r.Get("sampler-map-name"); value.Exists() && value.Type == gjson.String && !data.FlowIpv4EgressMonitorSamplers[i].SamplerMapName.IsNull() {
	...
	for i := range data.FlowIpv6IngressMonitors {
		...
		if value := r.Get("monitor-map-name"); value.Exists() && value.Type == gjson.String && !data.FlowIpv6IngressMonitors[i].MonitorMapName.IsNull() {
	...
	for i := range data.FlowIpv6IngressMonitorSamplers {
		...
		if value := r.Get("monitor-map-name"); value.Exists() && value.Type == gjson.String && !data.FlowIpv6IngressMonitorSamplers[i].MonitorMapName.IsNull() {
		...
		if value := r.Get("sampler-map-name"); value.Exists() && value.Type == gjson.String && !data.FlowIpv6IngressMonitorSamplers[i].SamplerMapName.IsNull() {
	...
	for i := range data.FlowIpv6EgressMonitors {
		...
		if value := r.Get("monitor-map-name"); value.Exists() && value.Type == gjson.String && !data.FlowIpv6EgressMonitors[i].MonitorMapName.IsNull() {
	...
	for i := range data.FlowIpv6EgressMonitorSamplers {
		...
		if value := r.Get("monitor-map-name"); value.Exists() && value.Type == gjson.String && !data.FlowIpv6EgressMonitorSamplers[i].MonitorMapName.IsNull() {
		...
		if value := r.Get("sampler-map-name"); value.Exists() && value.Type == gjson.String && !data.FlowIpv6EgressMonitorSamplers[i].SamplerMapName.IsNull() {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency.synchronization.priority"); value.Exists() && value.Type == gjson.Number && !data.FrequencySynchronizationPriority.IsNull() {
		data.FrequencySynchronizationPriority = types.Int64Value(value.Int())
	} else {
		data.FrequencySynchronizationPriority = types.Int64Null()
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency.synchronization.time-of-day-priority"); value.Exists() && value.Type == gjson.Number && !data.FrequencySynchronizationTimeOfDayPriority.IsNull() {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency.synchronization.quality.transmit.lowest.itu-t.option.one"); value.Exists() && value.Type == gjson.String && !data.FrequencySynchronizationQualityTransmitLowestItuTOptionOne.IsNull() {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency.synchronization.quality.transmit.lowest.itu-t.option.two.generation.one"); value.Exists() && value.Type == gjson.String && !data.FrequencySynchronizationQualityTransmitLowestItuTOptionTwoGenerationOne.IsNull() {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency.synchronization.quality.transmit.lowest.itu-t.option.two.generation.two"); value.Exists() && value.Type == gjson.String && !data.FrequencySynchronizationQualityTransmitLowestItuTOptionTwoGenerationTwo.IsNull() {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency.synchronization.quality.transmit.highest.itu-t.option.one"); value.Exists() && value.Type == gjson.String && !data.FrequencySynchronizationQualityTransmitHighestItuTOptionOne.IsNull() {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency.synchronization.quality.transmit.highest.itu-t.option.two.generation.one"); value.Exists() && value.Type == gjson.String && !data.FrequencySynchronizationQualityTransmitHighestItuTOptionTwoGenerationOne.IsNull() {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency.synchronization.quality.transmit.highest.itu-t.option.two.generation.two"); value.Exists() && value.Type == gjson.String && !data.FrequencySynchronizationQualityTransmitHighestItuTOptionTwoGenerationTwo.IsNull() {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency.synchronization.quality.transmit.exact.itu-t.option.one"); value.Exists() && value.Type == gjson.String && !data.FrequencySynchronizationQualityTransmitExactItuTOptionOne.IsNull() {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency.synchronization.quality.transmit.exact.itu-t.option.two.generation.one"); value.Exists() && value.Type == gjson.String && !data.FrequencySynchronizationQualityTransmitExactItuTOptionTwoGenerationOne.IsNull() {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency.synchronization.quality.transmit.exact.itu-t.option.two.generation.two"); value.Exists() && value.Type == gjson.String && !data.FrequencySynchronizationQualityTransmitExactItuTOptionTwoGenerationTwo.IsNull() {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency.synchronization.quality.receive.lowest.itu-t.option.one"); value.Exists() && value.Type == gjson.String && !data.FrequencySynchronizationQualityReceiveLowestItuTOptionOne.IsNull() {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency.synchronization.quality.receive.lowest.itu-t.option.two.generation.one"); value.Exists() && value.Type == gjson.String && !data.FrequencySynchronizationQualityReceiveLowestItuTOptionTwoGenerationOne.IsNull() {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency.synchronization.quality.receive.lowest.itu-t.option.two.generation.two"); value.Exists() && value.Type == gjson.String && !data.FrequencySynchronizationQualityReceiveLowestItuTOptionTwoGenerationTwo.IsNull() {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency.synchronization.quality.receive.highest.itu-t.option.one"); value.Exists() && value.Type == gjson.String && !data.FrequencySynchronizationQualityReceiveHighestItuTOptionOne.IsNull() {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency.synchronization.quality.receive.highest.itu-t.option.two.generation.one"); value.Exists() && value.Type == gjson.String && !data.FrequencySynchronizationQualityReceiveHighestItuTOptionTwoGenerationOne.IsNull() {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency.synchronization.quality.receive.highest.itu-t.option.two.generation.two"); value.Exists() && value.Type == gjson.String && !data.FrequencySynchronizationQualityReceiveHighestItuTOptionTwoGenerationTwo.IsNull() {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency.synchronization.quality.receive.exact.itu-t.option.one"); value.Exists() && value.Type == gjson.String && !data.FrequencySynchronizationQualityReceiveExactItuTOptionOne.IsNull() {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency.synchronization.quality.receive.exact.itu-t.option.two.generation.one"); value.Exists() && value.Type == gjson.String && !data.FrequencySynchronizationQualityReceiveExactItuTOptionTwoGenerationOne.IsNull() {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency.synchronization.quality.receive.exact.itu-t.option.two.generation.two"); value.Exists() && value.Type == gjson.String && !data.FrequencySynchronizationQualityReceiveExactItuTOptionTwoGenerationTwo.IsNull() {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency.synchronization.wait-to-restore"); value.Exists() && value.Type == gjson.Number && !data.FrequencySynchronizationWaitToRestore.IsNull() {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-arp-cfg:arp.timeout"); value.Exists() && value.Type == gjson.Number && !data.ArpTimeout.IsNull() {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-arp-cfg:arp.cache-limit"); value.Exists() && value.Type == gjson.Number && !data.ArpCacheLimit.IsNull() {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-bundle-cfg:bundle.id.bundle-id"); value.Exists() && value.Type == gjson.Number && !data.BundleId.IsNull() {
		data.BundleId = types.Int64Value(value.Int())
	} else {
		data.BundleId = types.Int64Null()
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-bundle-cfg:bundle.id.mode"); value.Exists() && value.Type == gjson.String && !data.BundleIdMode.IsNull() {
		data.BundleIdMode = types.StringValue(value.String())
	} else {
		data.BundleIdMode = types.StringNull()
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-bundle-cfg:bundle.port-priority"); value.Exists() && value.Type == gjson.Number && !data.BundlePortPriority.IsNull() {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-bundle-cfg:lacp.period.transmission-id"); value.Exists() && value.Type == gjson.Number && !data.LacpPeriod.IsNull() {
		data.LacpPeriod = types.Int64Value(value.Int())
	} else {
		data.LacpPeriod = types.Int64Null()
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-ethernet-cfg:carrier-delay.up"); value.Exists() && value.Type == gjson.Number && !data.CarrierDelayUp.IsNull() {
		data.CarrierDelayUp = types.Int64Value(value.Int())
	} else {
		data.CarrierDelayUp = types.Int64Null()
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-ethernet-cfg:carrier-delay.down"); value.Exists() && value.Type == gjson.Number && !data.CarrierDelayDown.IsNull() {
		data.CarrierDelayDown = types.Int64Value(value.Int())
	} else {
		data.CarrierDelayDown = types.Int64Null()
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-mac-address-cfg:mac-address"); value.Exists() && value.Type == gjson.String && !data.MacAddress.IsNull() {
		data.MacAddress = types.StringValue(value.String())
	} else {
		data.MacAddress = types.StringNull()
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-mpls-cfg:mpls.mtu"); value.Exists() && value.Type == gjson.Number && !data.MplsMtu.IsNull() {
		data.MplsMtu = types.Int64Value(value.Int())
	} else {
		data.MplsMtu = types.Int64Null()
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-ethernet-cfg:speed"); value.Exists() && value.Type == gjson.String && !data.Speed.IsNull() {
		data.Speed = types.StringValue(value.String())
	} else {
		data.Speed = types.StringNull()
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-ethernet-cfg:duplex"); value.Exists() && value.Type == gjson.String && !data.Duplex.IsNull() {
		data.Duplex = types.StringValue(value.String())
	} else {
		data.Duplex = types.StringNull()
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-ethernet-cfg:flow-control"); value.Exists() && value.Type == gjson.String && !data.FlowControl.IsNull() {
		data.FlowControl = types.StringValue(value.String())
	} else {
		data.FlowControl = types.StringNull()
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-ethernet-cfg:fec"); value.Exists() && value.Type == gjson.String && !data.Fec.IsNull() {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-macsec-cfg:macsec.psk-keychain.keychain-name"); value.Exists() && value.Type == gjson.String && !data.MacsecPskKeychainName.IsNull() {
		data.MacsecPskKeychainName = types.StringValue(value.String())
	} else {
		data.MacsecPskKeychainName = types.StringNull()
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-macsec-cfg:macsec.psk-keychain.fallback-psk-keychain"); value.Exists() && value.Type == gjson.String && !data.MacsecFallbackPskKeychain.IsNull() {
		data.MacsecFallbackPskKeychain = types.StringValue(value.String())
	} else {
		data.MacsecFallbackPskKeychain = types.StringNull()
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-macsec-cfg:macsec.psk-keychain.policy"); value.Exists() && value.Type == gjson.String && !data.MacsecPolicy.IsNull() {
		data.MacsecPolicy = types.StringValue(value.String())
	} else {
		data.MacsecPolicy = types.StringNull()
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-macsec-cfg:eap.policy"); value.Exists() && value.Type == gjson.String && !data.MacsecEapPolicy.IsNull() {
	...
	for i := range data.MonitorSessions {
		...
		if value := r.Get("acl-ipv4.acl-name"); value.Exists() && value.Type == gjson.String && !data.MonitorSessions[i].AclIpv4Name.IsNull() {
			data.MonitorSessions[i].AclIpv4Name = types.StringValue(value.String())
		} else {
			data.MonitorSessions[i].AclIpv4Name = types.StringNull()
		}
		if value := r.Get("acl-ipv6.acl-name"); value.Exists() && value.Type == gjson.String && !data.MonitorSessions[i].AclIpv6Name.IsNull() {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.profile"); value.Exists() && value.Type == gjson.String && !data.PtpProfile.IsNull() {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.announce.interval"); value.Exists() && value.Type == gjson.String && !data.PtpAnnounceInterval.IsNull() {
		data.PtpAnnounceInterval = types.StringValue(value.String())
	} else {
		data.PtpAnnounceInterval = types.StringNull()
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.announce.frequency"); value.Exists() && value.Type == gjson.String && !data.PtpAnnounceFrequency.IsNull() {
		data.PtpAnnounceFrequency = types.StringValue(value.String())
	} else {
		data.PtpAnnounceFrequency = types.StringNull()
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.announce.timeout"); value.Exists() && value.Type == gjson.Number && !data.PtpAnnounceTimeout.IsNull() {
		data.PtpAnnounceTimeout = types.Int64Value(value.Int())
	} else {
		data.PtpAnnounceTimeout = types.Int64Null()
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.announce.grant-duration"); value.Exists() && value.Type == gjson.Number && !data.PtpAnnounceGrantDuration.IsNull() {
		data.PtpAnnounceGrantDuration = types.Int64Value(value.Int())
	} else {
		data.PtpAnnounceGrantDuration = types.Int64Null()
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.sync.interval"); value.Exists() && value.Type == gjson.String && !data.PtpSyncInterval.IsNull() {
		data.PtpSyncInterval = types.StringValue(value.String())
	} else {
		data.PtpSyncInterval = types.StringNull()
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.sync.frequency"); value.Exists() && value.Type == gjson.String && !data.PtpSyncFrequency.IsNull() {
		data.PtpSyncFrequency = types.StringValue(value.String())
	} else {
		data.PtpSyncFrequency = types.StringNull()
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.sync.grant-duration"); value.Exists() && value.Type == gjson.Number && !data.PtpSyncGrantDuration.IsNull() {
		data.PtpSyncGrantDuration = types.Int64Value(value.Int())
	} else {
		data.PtpSyncGrantDuration = types.Int64Null()
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.sync.timeout"); value.Exists() && value.Type == gjson.Number && !data.PtpSyncTimeout.IsNull() {
		data.PtpSyncTimeout = types.Int64Value(value.Int())
	} else {
		data.PtpSyncTimeout = types.Int64Null()
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.delay-request.interval"); value.Exists() && value.Type == gjson.String && !data.PtpDelayRequestInterval.IsNull() {
		data.PtpDelayRequestInterval = types.StringValue(value.String())
	} else {
		data.PtpDelayRequestInterval = types.StringNull()
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.delay-request.frequency"); value.Exists() && value.Type == gjson.String && !data.PtpDelayRequestFrequency.IsNull() {
		data.PtpDelayRequestFrequency = types.StringValue(value.String())
	} else {
		data.PtpDelayRequestFrequency = types.StringNull()
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.cos"); value.Exists() && value.Type == gjson.Number && !data.PtpCos.IsNull() {
		data.PtpCos = types.Int64Value(value.Int())
	} else {
		data.PtpCos = types.Int64Null()
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.event-cos"); value.Exists() && value.Type == gjson.Number && !data.PtpCosEvent.IsNull() {
		data.PtpCosEvent = types.Int64Value(value.Int())
	} else {
		data.PtpCosEvent = types.Int64Null()
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.general-cos"); value.Exists() && value.Type == gjson.Number && !data.PtpCosGeneral.IsNull() {
		data.PtpCosGeneral = types.Int64Value(value.Int())
	} else {
		data.PtpCosGeneral = types.Int64Null()
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.dscp"); value.Exists() && value.Type == gjson.Number && !data.PtpDscp.IsNull() {
		data.PtpDscp = types.Int64Value(value.Int())
	} else {
		data.PtpDscp = types.Int64Null()
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.event-dscp"); value.Exists() && value.Type == gjson.Number && !data.PtpDscpEvent.IsNull() {
		data.PtpDscpEvent = types.Int64Value(value.Int())
	} else {
		data.PtpDscpEvent = types.Int64Null()
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.general-dscp"); value.Exists() && value.Type == gjson.Number && !data.PtpDscpGeneral.IsNull() {
		data.PtpDscpGeneral = types.Int64Value(value.Int())
	} else {
		data.PtpDscpGeneral = types.Int64Null()
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.ipv4-ttl"); value.Exists() && value.Type == gjson.Number && !data.PtpIpv4Ttl.IsNull() {
		data.PtpIpv4Ttl = types.Int64Value(value.Int())
	} else {
		data.PtpIpv4Ttl = types.Int64Null()
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.ipv6-hop-limit"); value.Exists() && value.Type == gjson.Number && !data.PtpIpv6HopLimit.IsNull() {
		data.PtpIpv6HopLimit = types.Int64Value(value.Int())
	} else {
		data.PtpIpv6HopLimit = types.Int64Null()
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.delay-asymmetry"); value.Exists() && value.Type == gjson.Number && !data.PtpDelayAsymmetryValue.IsNull() {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.delay-response.grant-duration"); value.Exists() && value.Type == gjson.Number && !data.PtpDelayResponseGrantDuration.IsNull() {
		data.PtpDelayResponseGrantDuration = types.Int64Value(value.Int())
	} else {
		data.PtpDelayResponseGrantDuration = types.Int64Null()
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.delay-response.timeout"); value.Exists() && value.Type == gjson.Number && !data.PtpDelayResponseTimeout.IsNull() {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.source.ipv4.address.ipv4-address"); value.Exists() && value.Type == gjson.String && !data.PtpSourceIpv4Address.IsNull() {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.source.ipv6.address.ipv6-address"); value.Exists() && value.Type == gjson.String && !data.PtpSourceIpv6Address.IsNull() {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.local-priority"); value.Exists() && value.Type == gjson.Number && !data.PtpLocalPriority.IsNull() {
	...
	for i := range data.PtpSlaveIpv4s {
		...
		if value := r.Get("address"); value.Exists() && value.Type == gjson.String && !data.PtpSlaveIpv4s[i].Address.IsNull() {
	...
	for i := range data.PtpSlaveIpv6s {
		...
		if value := r.Get("address"); value.Exists() && value.Type == gjson.String && !data.PtpSlaveIpv6s[i].Address.IsNull() {
	...
	for i := range data.PtpSlaveEthernets {
		...
		if value := r.Get("address"); value.Exists() && value.Type == gjson.String && !data.PtpSlaveEthernets[i].Address.IsNull() {
	...
	for i := range data.PtpMasterIpv4s {
		...
		if value := r.Get("address"); value.Exists() && value.Type == gjson.String && !data.PtpMasterIpv4s[i].Address.IsNull() {
			data.PtpMasterIpv4s[i].Address = types.StringValue(value.String())
		} else {
			data.PtpMasterIpv4s[i].Address = types.StringNull()
		}
		if value := r.Get("priority"); value.Exists() && value.Type == gjson.Number && !data.PtpMasterIpv4s[i].Priority.IsNull() {
			data.PtpMasterIpv4s[i].Priority = types.Int64Value(value.Int())
		} else {
			data.PtpMasterIpv4s[i].Priority = types.Int64Null()
		}
		if value := r.Get("clock-class"); value.Exists() && value.Type == gjson.Number && !data.PtpMasterIpv4s[i].ClockClass.IsNull() {
		...
		if value := r.Get("delay-asymmetry"); value.Exists() && value.Type == gjson.Number && !data.PtpMasterIpv4s[i].DelayAsymmetry.IsNull() {
	...
	for i := range data.PtpMasterIpv6s {
		...
		if value := r.Get("address"); value.Exists() && value.Type == gjson.String && !data.PtpMasterIpv6s[i].Address.IsNull() {
			data.PtpMasterIpv6s[i].Address = types.StringValue(value.String())
		} else {
			data.PtpMasterIpv6s[i].Address = types.StringNull()
		}
		if value := r.Get("priority"); value.Exists() && value.Type == gjson.Number && !data.PtpMasterIpv6s[i].Priority.IsNull() {
			data.PtpMasterIpv6s[i].Priority = types.Int64Value(value.Int())
		} else {
			data.PtpMasterIpv6s[i].Priority = types.Int64Null()
		}
		if value := r.Get("clock-class"); value.Exists() && value.Type == gjson.Number && !data.PtpMasterIpv6s[i].ClockClass.IsNull() {
		...
		if value := r.Get("delay-asymmetry"); value.Exists() && value.Type == gjson.Number && !data.PtpMasterIpv6s[i].DelayAsymmetry.IsNull() {
	...
	for i := range data.PtpMasterEthernets {
		...
		if value := r.Get("address"); value.Exists() && value.Type == gjson.String && !data.PtpMasterEthernets[i].Address.IsNull() {
			data.PtpMasterEthernets[i].Address = types.StringValue(value.String())
		} else {
			data.PtpMasterEthernets[i].Address = types.StringNull()
		}
		if value := r.Get("priority"); value.Exists() && value.Type == gjson.Number && !data.PtpMasterEthernets[i].Priority.IsNull() {
			data.PtpMasterEthernets[i].Priority = types.Int64Value(value.Int())
		} else {
			data.PtpMasterEthernets[i].Priority = types.Int64Null()
		}
		if value := r.Get("clock-class"); value.Exists() && value.Type == gjson.Number && !data.PtpMasterEthernets[i].ClockClass.IsNull() {
		...
		if value := r.Get("delay-asymmetry"); value.Exists() && value.Type == gjson.Number && !data.PtpMasterEthernets[i].DelayAsymmetry.IsNull() {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.interop.domain"); value.Exists() && value.Type == gjson.Number && !data.PtpInteropDomain.IsNull() {
		data.PtpInteropDomain = types.Int64Value(value.Int())
	} else {
		data.PtpInteropDomain = types.Int64Null()
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.interop.egress-conversion.priority1"); value.Exists() && value.Type == gjson.Number && !data.PtpInteropEgressConversionPriority1.IsNull() {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.interop.egress-conversion.priority2"); value.Exists() && value.Type == gjson.Number && !data.PtpInteropEgressConversionPriority2.IsNull() {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.interop.egress-conversion.clock-accuracy"); value.Exists() && value.Type == gjson.Number && !data.PtpInteropEgressConversionClockAccuracy.IsNull() {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.interop.egress-conversion.offset-scaled-log-variance"); value.Exists() && value.Type == gjson.Number && !data.PtpInteropEgressConversionOffsetScaledLogVariance.IsNull() {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.interop.egress-conversion.clock-class.default"); value.Exists() && value.Type == gjson.Number && !data.PtpInteropEgressConversionClockClassDefault.IsNull() {
	...
	for i := range data.PtpInteropEgressConversionClockClassMappings {
		...
		if value := r.Get("clock-class-to-map-from"); value.Exists() && value.Type == gjson.Number && !data.PtpInteropEgressConversionClockClassMappings[i].ClockClassToMapFrom.IsNull() {
		...
		if value := r.Get("clock-class-to-map-to"); value.Exists() && value.Type == gjson.Number && !data.PtpInteropEgressConversionClockClassMappings[i].ClockClassToMapTo.IsNull() {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.interop.ingress-conversion.priority1"); value.Exists() && value.Type == gjson.Number && !data.PtpInteropIngressConversionPriority1.IsNull() {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.interop.ingress-conversion.priority2"); value.Exists() && value.Type == gjson.Number && !data.PtpInteropIngressConversionPriority2.IsNull() {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.interop.ingress-conversion.clock-accuracy"); value.Exists() && value.Type == gjson.Number && !data.PtpInteropIngressConversionClockAccuracy.IsNull() {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.interop.ingress-conversion.offset-scaled-log-variance"); value.Exists() && value.Type == gjson.Number && !data.PtpInteropIngressConversionOffsetScaledLogVariance.IsNull() {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.interop.ingress-conversion.clock-class.default"); value.Exists() && value.Type == gjson.Number && !data.PtpInteropIngressConversionClockClassDefault.IsNull() {
	...
	for i := range data.PtpInteropIngressConversionClockClassMappings {
		...
		if value := r.Get("clock-class-to-map-from"); value.Exists() && value.Type == gjson.Number && !data.PtpInteropIngressConversionClockClassMappings[i].ClockClassToMapFrom.IsNull() {
		...
		if value := r.Get("clock-class-to-map-to"); value.Exists() && value.Type == gjson.Number && !data.PtpInteropIngressConversionClockClassMappings[i].ClockClassToMapTo.IsNull() {
...
func (data *InterfaceEthernet) fromBody(ctx context.Context, res []byte, version string) {
	...
	if value := gjson.GetBytes(res, "dampening.decay-half-life.reuse-threshold.suppress-threshold.max-suppress-time.restart-penalty.value"); value.Exists() && value.Type == gjson.Number {
		data.DampeningRestartPenalty = types.Int64Value(value.Int())
	}
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-l2-ethernet-cfg:encapsulation.dot1q.vlan-id"); value.Exists() && value.Type == gjson.Number {
		data.EncapsulationDot1qVlanId = types.Int64Value(value.Int())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-l2-ethernet-cfg:encapsulation.dot1q.second-dot1q"); value.Exists() && value.Type == gjson.Number {
		data.EncapsulationDot1qSecondDot1q = types.Int64Value(value.Int())
	}
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-l2-ethernet-cfg:l2transport-encapsulation.dot1q.vlan-id"); value.Exists() && value.Type == gjson.String {
		data.L2transportEncapsulationDot1qVlanId = types.StringValue(value.String())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-l2-ethernet-cfg:l2transport-encapsulation.dot1q.second-dot1q"); value.Exists() && value.Type == gjson.String {
		data.L2transportEncapsulationDot1qSecondDot1q = types.StringValue(value.String())
	}
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-vrf-cfg:vrf"); value.Exists() && value.Type == gjson.String {
		data.Vrf = types.StringValue(value.String())
	}
	if value := gjson.GetBytes(res, "ipv4.Cisco-IOS-XR-um-if-ip-address-cfg:addresses.address.address"); value.Exists() && value.Type == gjson.String {
		data.Ipv4Address = types.StringValue(value.String())
	}
	if value := gjson.GetBytes(res, "ipv4.Cisco-IOS-XR-um-if-ip-address-cfg:addresses.address.netmask"); value.Exists() && value.Type == gjson.String {
		data.Ipv4Netmask = types.StringValue(value.String())
	}
	...
	if value := gjson.GetBytes(res, "ipv4.Cisco-IOS-XR-um-if-ip-address-cfg:addresses.unnumbered"); value.Exists() && value.Type == gjson.String {
		data.Ipv4Unnumbered = types.StringValue(value.String())
	}
	...
	if value := gjson.GetBytes(res, "ipv4.Cisco-IOS-XR-um-if-ipv4-cfg:verify.unicast.source.reachable-via.type"); value.Exists() && value.Type == gjson.String {
		data.Ipv4VerifyUnicastSourceReachableViaType = types.StringValue(value.String())
	}
	...
	if value := gjson.GetBytes(res, "ipv4.Cisco-IOS-XR-um-if-access-group-cfg:access-group.ingress.access-list-name-1.name"); value.Exists() && value.Type == gjson.String {
		data.Ipv4AccessGroupIngressAcl1 = types.StringValue(value.String())
	}
	...
	if value := gjson.GetBytes(res, "ipv4.Cisco-IOS-XR-um-if-access-group-cfg:access-group.ingress.compress"); value.Exists() && value.Type == gjson.Number {
		data.Ipv4AccessGroupIngressCompress = types.Int64Value(value.Int())
	}
	if value := gjson.GetBytes(res, "ipv4.Cisco-IOS-XR-um-if-access-group-cfg:access-group.egress.access-list-name.name"); value.Exists() && value.Type == gjson.String {
		data.Ipv4AccessGroupEgressAcl = types.StringValue(value.String())
	}
	...
	if value := gjson.GetBytes(res, "ipv4.Cisco-IOS-XR-um-if-access-group-cfg:access-group.egress.compress"); value.Exists() && value.Type == gjson.Number {
		data.Ipv4AccessGroupEgressCompress = types.Int64Value(value.Int())
	}
	if value := gjson.GetBytes(res, "ipv6.Cisco-IOS-XR-um-if-ipv6-cfg:verify.unicast.source.reachable-via.type"); value.Exists() && value.Type == gjson.String {
		data.Ipv6VerifyUnicastSourceReachableViaType = types.StringValue(value.String())
	}
	...
	if value := gjson.GetBytes(res, "ipv6.Cisco-IOS-XR-um-if-access-group-cfg:access-group.ingress.access-list-name-1.name"); value.Exists() && value.Type == gjson.String {
		data.Ipv6AccessGroupIngressAcl1 = types.StringValue(value.String())
	}
	...
	if value := gjson.GetBytes(res, "ipv6.Cisco-IOS-XR-um-if-access-group-cfg:access-group.ingress.compress"); value.Exists() && value.Type == gjson.Number {
		data.Ipv6AccessGroupIngressCompress = types.Int64Value(value.Int())
	}
	if value := gjson.GetBytes(res, "ipv6.Cisco-IOS-XR-um-if-access-group-cfg:access-group.egress.access-list-name.name"); value.Exists() && value.Type == gjson.String {
		data.Ipv6AccessGroupEgressAcl = types.StringValue(value.String())
	}
	...
	if value := gjson.GetBytes(res, "ipv6.Cisco-IOS-XR-um-if-access-group-cfg:access-group.egress.compress"); value.Exists() && value.Type == gjson.Number {
		data.Ipv6AccessGroupEgressCompress = types.Int64Value(value.Int())
	}
	...
	if value := gjson.GetBytes(res, "ipv6.Cisco-IOS-XR-um-if-ip-address-cfg:addresses.link-local-address.address"); value.Exists() && value.Type == gjson.String {
		data.Ipv6LinkLocalAddress = types.StringValue(value.String())
	}
	if value := gjson.GetBytes(res, "ipv6.Cisco-IOS-XR-um-if-ip-address-cfg:addresses.link-local-address.zone"); value.Exists() && value.Type == gjson.String {
		data.Ipv6LinkLocalZone = types.StringValue(value.String())
	}
	...
	if value := gjson.GetBytes(res, "ipv6.Cisco-IOS-XR-um-ipv6-nd-cfg:nd.reachable-time"); value.Exists() && value.Type == gjson.Number {
		data.Ipv6NdReachableTime = types.Int64Value(value.Int())
	}
	if value := gjson.GetBytes(res, "ipv6.Cisco-IOS-XR-um-ipv6-nd-cfg:nd.cache-limit"); value.Exists() && value.Type == gjson.Number {
		data.Ipv6NdCacheLimit = types.Int64Value(value.Int())
	}
	if value := gjson.GetBytes(res, "ipv6.Cisco-IOS-XR-um-ipv6-nd-cfg:nd.dad.attempts"); value.Exists() && value.Type == gjson.Number {
		data.Ipv6NdDadAttempts = types.Int64Value(value.Int())
	}
	...
	if value := gjson.GetBytes(res, "ipv6.Cisco-IOS-XR-um-ipv6-nd-cfg:nd.ns-interval"); value.Exists() && value.Type == gjson.Number {
		data.Ipv6NdNsInterval = types.Int64Value(value.Int())
	}
	if value := gjson.GetBytes(res, "ipv6.Cisco-IOS-XR-um-ipv6-nd-cfg:nd.ra-interval.maximum-ra-interval"); value.Exists() && value.Type == gjson.Number {
		data.Ipv6NdRaIntervalMax = types.Int64Value(value.Int())
	}
	if value := gjson.GetBytes(res, "ipv6.Cisco-IOS-XR-um-ipv6-nd-cfg:nd.ra-interval.minimum-ra-interval"); value.Exists() && value.Type == gjson.Number {
		data.Ipv6NdRaIntervalMin = types.Int64Value(value.Int())
	}
	if value := gjson.GetBytes(res, "ipv6.Cisco-IOS-XR-um-ipv6-nd-cfg:nd.ra-lifetime"); value.Exists() && value.Type == gjson.Number {
		data.Ipv6NdRaLifetime = types.Int64Value(value.Int())
	}
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ethernet-cfm-cfg:ethernet.cfm.mep.domain"); value.Exists() {
		...
		value.ForEach(func(k, v gjson.Result) bool {
			...
			if cValue := v.Get("service"); cValue.Exists() && cValue.Type == gjson.String {
				item.Service = types.StringValue(cValue.String())
			}
			if cValue := v.Get("mep-id"); cValue.Exists() && cValue.Type == gjson.Number {
			...
			if cValue := v.Get("cos"); cValue.Exists() && cValue.Type == gjson.Number {
			...
			if cValue := v.Get("loss-measurement.counters.priority.cos-range.start-of-cos-range"); cValue.Exists() && cValue.Type == gjson.Number {
				item.LossMeasurementCountersPriorityCosRangeStart = types.Int64Value(cValue.Int())
			}
			if cValue := v.Get("loss-measurement.counters.priority.cos-range.end-of-cos-range"); cValue.Exists() && cValue.Type == gjson.Number {
				item.LossMeasurementCountersPriorityCosRangeEnd = types.Int64Value(cValue.Int())
			}
			if cValue := v.Get("loss-measurement.counters.priority.cos-values.cos-value1"); cValue.Exists() && cValue.Type == gjson.Number {
				item.LossMeasurementCountersPriorityCosValue1 = types.Int64Value(cValue.Int())
			}
			if cValue := v.Get("loss-measurement.counters.priority.cos-values.cos-value2"); cValue.Exists() && cValue.Type == gjson.Number {
				item.LossMeasurementCountersPriorityCosValue2 = types.Int64Value(cValue.Int())
			}
			if cValue := v.Get("loss-measurement.counters.priority.cos-values.cos-value3"); cValue.Exists() && cValue.Type == gjson.Number {
				item.LossMeasurementCountersPriorityCosValue3 = types.Int64Value(cValue.Int())
			}
			if cValue := v.Get("loss-measurement.counters.priority.cos-values.cos-value4"); cValue.Exists() && cValue.Type == gjson.Number {
				item.LossMeasurementCountersPriorityCosValue4 = types.Int64Value(cValue.Int())
			}
			if cValue := v.Get("loss-measurement.counters.priority.cos-values.cos-value5"); cValue.Exists() && cValue.Type == gjson.Number {
				item.LossMeasurementCountersPriorityCosValue5 = types.Int64Value(cValue.Int())
			}
			if cValue := v.Get("loss-measurement.counters.priority.cos-values.cos-value6"); cValue.Exists() && cValue.Type == gjson.Number {
				item.LossMeasurementCountersPriorityCosValue6 = types.Int64Value(cValue.Int())
			}
			if cValue := v.Get("loss-measurement.counters.priority.cos-values.cos-value7"); cValue.Exists() && cValue.Type == gjson.Number {
			...
			if cValue := v.Get("sla.operation.profile.target.mep-id.profile-target-mep-id"); cValue.Exists() {
				...
				cValue.ForEach(func(ck, cv gjson.Result) bool {
					...
					if ccValue := cv.Get("profile-name"); ccValue.Exists() && ccValue.Type == gjson.String {
						cItem.ProfileName = types.StringValue(ccValue.String())
					}
					if ccValue := cv.Get("mep-id"); ccValue.Exists() && ccValue.Type == gjson.Number {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ethernet-cfm-cfg:ethernet.cfm.ais.transmission.up.interval"); value.Exists() && value.Type == gjson.String {
		data.EthernetCfmAisTransmissionUpInterval = types.StringValue(value.String())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ethernet-cfm-cfg:ethernet.cfm.ais.transmission.up.cos"); value.Exists() && value.Type == gjson.Number {
		data.EthernetCfmAisTransmissionUpCos = types.Int64Value(value.Int())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ethernet-cfm-cfg:ethernet.cfm.bandwidth-notifications.hold-off"); value.Exists() && value.Type == gjson.Number {
		data.EthernetCfmBandwidthNotificationsHoldOff = types.Int64Value(value.Int())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ethernet-cfm-cfg:ethernet.cfm.bandwidth-notifications.wait-to-restore"); value.Exists() && value.Type == gjson.Number {
		data.EthernetCfmBandwidthNotificationsWaitToRestore = types.Int64Value(value.Int())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ethernet-cfm-cfg:ethernet.cfm.bandwidth-notifications.loss-threshold"); value.Exists() && value.Type == gjson.Number {
		data.EthernetCfmBandwidthNotificationsLossThreshold = types.Int64Value(value.Int())
	}
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-flow-cfg:flow.ipv4.monitor.ingress-monitors.ingress-monitor"); value.Exists() {
		...
		value.ForEach(func(k, v gjson.Result) bool {
			...
			if cValue := v.Get("monitor-map-name"); cValue.Exists() && cValue.Type == gjson.String {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-flow-cfg:flow.ipv4.monitor.ingress-monitor-samplers.ingress-monitor-sampler"); value.Exists() {
		...
		value.ForEach(func(k, v gjson.Result) bool {
			...
			if cValue := v.Get("sampler-map-name"); cValue.Exists() && cValue.Type == gjson.String {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency.synchronization.priority"); value.Exists() && value.Type == gjson.Number {
		data.FrequencySynchronizationPriority = types.Int64Value(value.Int())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency.synchronization.time-of-day-priority"); value.Exists() && value.Type == gjson.Number {
		data.FrequencySynchronizationTimeOfDayPriority = types.Int64Value(value.Int())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency.synchronization.quality.transmit.lowest.itu-t.option.one"); value.Exists() && value.Type == gjson.String {
		data.FrequencySynchronizationQualityTransmitLowestItuTOptionOne = types.StringValue(value.String())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency.synchronization.quality.transmit.lowest.itu-t.option.two.generation.one"); value.Exists() && value.Type == gjson.String {
		data.FrequencySynchronizationQualityTransmitLowestItuTOptionTwoGenerationOne = types.StringValue(value.String())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency.synchronization.quality.transmit.lowest.itu-t.option.two.generation.two"); value.Exists() && value.Type == gjson.String {
		data.FrequencySynchronizationQualityTransmitLowestItuTOptionTwoGenerationTwo = types.StringValue(value.String())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency.synchronization.quality.transmit.highest.itu-t.option.one"); value.Exists() && value.Type == gjson.String {
		data.FrequencySynchronizationQualityTransmitHighestItuTOptionOne = types.StringValue(value.String())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency.synchronization.quality.transmit.highest.itu-t.option.two.generation.one"); value.Exists() && value.Type == gjson.String {
		data.FrequencySynchronizationQualityTransmitHighestItuTOptionTwoGenerationOne = types.StringValue(value.String())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency.synchronization.quality.transmit.highest.itu-t.option.two.generation.two"); value.Exists() && value.Type == gjson.String {
		data.FrequencySynchronizationQualityTransmitHighestItuTOptionTwoGenerationTwo = types.StringValue(value.String())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency.synchronization.quality.transmit.exact.itu-t.option.one"); value.Exists() && value.Type == gjson.String {
		data.FrequencySynchronizationQualityTransmitExactItuTOptionOne = types.StringValue(value.String())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency.synchronization.quality.transmit.exact.itu-t.option.two.generation.one"); value.Exists() && value.Type == gjson.String {
		data.FrequencySynchronizationQualityTransmitExactItuTOptionTwoGenerationOne = types.StringValue(value.String())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency.synchronization.quality.transmit.exact.itu-t.option.two.generation.two"); value.Exists() && value.Type == gjson.String {
		data.FrequencySynchronizationQualityTransmitExactItuTOptionTwoGenerationTwo = types.StringValue(value.String())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency.synchronization.quality.receive.lowest.itu-t.option.one"); value.Exists() && value.Type == gjson.String {
		data.FrequencySynchronizationQualityReceiveLowestItuTOptionOne = types.StringValue(value.String())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency.synchronization.quality.receive.lowest.itu-t.option.two.generation.one"); value.Exists() && value.Type == gjson.String {
		data.FrequencySynchronizationQualityReceiveLowestItuTOptionTwoGenerationOne = types.StringValue(value.String())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency.synchronization.quality.receive.lowest.itu-t.option.two.generation.two"); value.Exists() && value.Type == gjson.String {
		data.FrequencySynchronizationQualityReceiveLowestItuTOptionTwoGenerationTwo = types.StringValue(value.String())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency.synchronization.quality.receive.highest.itu-t.option.one"); value.Exists() && value.Type == gjson.String {
		data.FrequencySynchronizationQualityReceiveHighestItuTOptionOne = types.StringValue(value.String())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency.synchronization.quality.receive.highest.itu-t.option.two.generation.one"); value.Exists() && value.Type == gjson.String {
		data.FrequencySynchronizationQualityReceiveHighestItuTOptionTwoGenerationOne = types.StringValue(value.String())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency.synchronization.quality.receive.highest.itu-t.option.two.generation.two"); value.Exists() && value.Type == gjson.String {
		data.FrequencySynchronizationQualityReceiveHighestItuTOptionTwoGenerationTwo = types.StringValue(value.String())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency.synchronization.quality.receive.exact.itu-t.option.one"); value.Exists() && value.Type == gjson.String {
		data.FrequencySynchronizationQualityReceiveExactItuTOptionOne = types.StringValue(value.String())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency.synchronization.quality.receive.exact.itu-t.option.two.generation.one"); value.Exists() && value.Type == gjson.String {
		data.FrequencySynchronizationQualityReceiveExactItuTOptionTwoGenerationOne = types.StringValue(value.String())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency.synchronization.quality.receive.exact.itu-t.option.two.generation.two"); value.Exists() && value.Type == gjson.String {
		data.FrequencySynchronizationQualityReceiveExactItuTOptionTwoGenerationTwo = types.StringValue(value.String())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency.synchronization.wait-to-restore"); value.Exists() && value.Type == gjson.Number {
		data.FrequencySynchronizationWaitToRestore = types.Int64Value(value.Int())
	}
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-arp-cfg:arp.timeout"); value.Exists() && value.Type == gjson.Number {
		data.ArpTimeout = types.Int64Value(value.Int())
	}
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-arp-cfg:arp.cache-limit"); value.Exists() && value.Type == gjson.Number {
		data.ArpCacheLimit = types.Int64Value(value.Int())
	}
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-bundle-cfg:bundle.id.bundle-id"); value.Exists() && value.Type == gjson.Number {
		data.BundleId = types.Int64Value(value.Int())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-bundle-cfg:bundle.id.mode"); value.Exists() && value.Type == gjson.String {
		data.BundleIdMode = types.StringValue(value.String())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-bundle-cfg:bundle.port-priority"); value.Exists() && value.Type == gjson.Number {
		data.BundlePortPriority = types.Int64Value(value.Int())
	}
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-bundle-cfg:lacp.period.transmission-id"); value.Exists() && value.Type == gjson.Number {
		data.LacpPeriod = types.Int64Value(value.Int())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-ethernet-cfg:carrier-delay.up"); value.Exists() && value.Type == gjson.Number {
		data.CarrierDelayUp = types.Int64Value(value.Int())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-ethernet-cfg:carrier-delay.down"); value.Exists() && value.Type == gjson.Number {
		data.CarrierDelayDown = types.Int64Value(value.Int())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-mac-address-cfg:mac-address"); value.Exists() && value.Type == gjson.String {
		data.MacAddress = types.StringValue(value.String())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-mpls-cfg:mpls.mtu"); value.Exists() && value.Type == gjson.Number {
		data.MplsMtu = types.Int64Value(value.Int())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-ethernet-cfg:speed"); value.Exists() && value.Type == gjson.String {
		data.Speed = types.StringValue(value.String())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-ethernet-cfg:duplex"); value.Exists() && value.Type == gjson.String {
		data.Duplex = types.StringValue(value.String())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-ethernet-cfg:flow-control"); value.Exists() && value.Type == gjson.String {
		data.FlowControl = types.StringValue(value.String())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-ethernet-cfg:fec"); value.Exists() && value.Type == gjson.String {
		data.Fec = types.StringValue(value.String())
	}
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-macsec-cfg:macsec.psk-keychain.keychain-name"); value.Exists() && value.Type == gjson.String {
		data.MacsecPskKeychainName = types.StringValue(value.String())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-macsec-cfg:macsec.psk-keychain.fallback-psk-keychain"); value.Exists() && value.Type == gjson.String {
		data.MacsecFallbackPskKeychain = types.StringValue(value.String())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-macsec-cfg:macsec.psk-keychain.policy"); value.Exists() && value.Type == gjson.String {
		data.MacsecPolicy = types.StringValue(value.String())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-macsec-cfg:eap.policy"); value.Exists() && value.Type == gjson.String {
		data.MacsecEapPolicy = types.StringValue(value.String())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-monitor-session-cfg:monitor-sessions.monitor-session"); value.Exists() {
		...
		value.ForEach(func(k, v gjson.Result) bool {
			...
			if cValue := v.Get("acl-ipv4.acl-name"); cValue.Exists() && cValue.Type == gjson.String {
				item.AclIpv4Name = types.StringValue(cValue.String())
			}
			if cValue := v.Get("acl-ipv6.acl-name"); cValue.Exists() && cValue.Type == gjson.String {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.profile"); value.Exists() && value.Type == gjson.String {
		data.PtpProfile = types.StringValue(value.String())
	}
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.announce.interval"); value.Exists() && value.Type == gjson.String {
		data.PtpAnnounceInterval = types.StringValue(value.String())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.announce.frequency"); value.Exists() && value.Type == gjson.String {
		data.PtpAnnounceFrequency = types.StringValue(value.String())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.announce.timeout"); value.Exists() && value.Type == gjson.Number {
		data.PtpAnnounceTimeout = types.Int64Value(value.Int())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.announce.grant-duration"); value.Exists() && value.Type == gjson.Number {
		data.PtpAnnounceGrantDuration = types.Int64Value(value.Int())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.sync.interval"); value.Exists() && value.Type == gjson.String {
		data.PtpSyncInterval = types.StringValue(value.String())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.sync.frequency"); value.Exists() && value.Type == gjson.String {
		data.PtpSyncFrequency = types.StringValue(value.String())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.sync.grant-duration"); value.Exists() && value.Type == gjson.Number {
		data.PtpSyncGrantDuration = types.Int64Value(value.Int())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.sync.timeout"); value.Exists() && value.Type == gjson.Number {
		data.PtpSyncTimeout = types.Int64Value(value.Int())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.delay-request.interval"); value.Exists() && value.Type == gjson.String {
		data.PtpDelayRequestInterval = types.StringValue(value.String())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.delay-request.frequency"); value.Exists() && value.Type == gjson.String {
		data.PtpDelayRequestFrequency = types.StringValue(value.String())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.cos"); value.Exists() && value.Type == gjson.Number {
		data.PtpCos = types.Int64Value(value.Int())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.event-cos"); value.Exists() && value.Type == gjson.Number {
		data.PtpCosEvent = types.Int64Value(value.Int())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.general-cos"); value.Exists() && value.Type == gjson.Number {
		data.PtpCosGeneral = types.Int64Value(value.Int())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.dscp"); value.Exists() && value.Type == gjson.Number {
		data.PtpDscp = types.Int64Value(value.Int())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.event-dscp"); value.Exists() && value.Type == gjson.Number {
		data.PtpDscpEvent = types.Int64Value(value.Int())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.general-dscp"); value.Exists() && value.Type == gjson.Number {
		data.PtpDscpGeneral = types.Int64Value(value.Int())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.ipv4-ttl"); value.Exists() && value.Type == gjson.Number {
		data.PtpIpv4Ttl = types.Int64Value(value.Int())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.ipv6-hop-limit"); value.Exists() && value.Type == gjson.Number {
		data.PtpIpv6HopLimit = types.Int64Value(value.Int())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.delay-asymmetry"); value.Exists() && value.Type == gjson.Number {
		data.PtpDelayAsymmetryValue = types.Int64Value(value.Int())
	}
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.delay-response.grant-duration"); value.Exists() && value.Type == gjson.Number {
		data.PtpDelayResponseGrantDuration = types.Int64Value(value.Int())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.delay-response.timeout"); value.Exists() && value.Type == gjson.Number {
		data.PtpDelayResponseTimeout = types.Int64Value(value.Int())
	}
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.source.ipv4.address.ipv4-address"); value.Exists() && value.Type == gjson.String {
		data.PtpSourceIpv4Address = types.StringValue(value.String())
	}
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.source.ipv6.address.ipv6-address"); value.Exists() && value.Type == gjson.String {
		data.PtpSourceIpv6Address = types.StringValue(value.String())
	}
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.local-priority"); value.Exists() && value.Type == gjson.Number {
		data.PtpLocalPriority = types.Int64Value(value.Int())
	}
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.interop.domain"); value.Exists() && value.Type == gjson.Number {
		data.PtpInteropDomain = types.Int64Value(value.Int())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.interop.egress-conversion.priority1"); value.Exists() && value.Type == gjson.Number {
		data.PtpInteropEgressConversionPriority1 = types.Int64Value(value.Int())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.interop.egress-conversion.priority2"); value.Exists() && value.Type == gjson.Number {
		data.PtpInteropEgressConversionPriority2 = types.Int64Value(value.Int())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.interop.egress-conversion.clock-accuracy"); value.Exists() && value.Type == gjson.Number {
		data.PtpInteropEgressConversionClockAccuracy = types.Int64Value(value.Int())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.interop.egress-conversion.offset-scaled-log-variance"); value.Exists() && value.Type == gjson.Number {
		data.PtpInteropEgressConversionOffsetScaledLogVariance = types.Int64Value(value.Int())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.interop.egress-conversion.clock-class.default"); value.Exists() && value.Type == gjson.Number {
		data.PtpInteropEgressConversionClockClassDefault = types.Int64Value(value.Int())
	}
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.interop.ingress-conversion.priority1"); value.Exists() && value.Type == gjson.Number {
		data.PtpInteropIngressConversionPriority1 = types.Int64Value(value.Int())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.interop.ingress-conversion.priority2"); value.Exists() && value.Type == gjson.Number {
		data.PtpInteropIngressConversionPriority2 = types.Int64Value(value.Int())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.interop.ingress-conversion.clock-accuracy"); value.Exists() && value.Type == gjson.Number {
		data.PtpInteropIngressConversionClockAccuracy = types.Int64Value(value.Int())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.interop.ingress-conversion.offset-scaled-log-variance"); value.Exists() && value.Type == gjson.Number {
		data.PtpInteropIngressConversionOffsetScaledLogVariance = types.Int64Value(value.Int())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-ptp-cfg:ptp.interop.ingress-conversion.clock-class.default"); value.Exists() && value.Type == gjson.Number {
		data.PtpInteropIngressConversionClockClassDefault = types.Int64Value(value.Int())
	}
...
func (data *InterfaceEthernetData) fromBody(ctx context.Context, res []byte, version string) {
	if value := gjson.GetBytes(res, "sub-interface-type.point-to-point"); value.Exists() {
		data.PointToPoint = types.BoolValue(true)
	} else {
		data.PointToPoint = types.BoolValue(false)
...
func (data *InterfaceEthernet) getDeletedItems(ctx context.Context, state InterfaceEthernet, version string) []string {
	...
	if !state.LldpTagged.IsNull() && data.LldpTagged.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "Cisco-IOS-XR-um-lldp-cfg:lldp/tagged"))
	}
	...
	if !state.NegotiationAutoAllowOverrides.IsNull() && data.NegotiationAutoAllowOverrides.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "Cisco-IOS-XR-um-if-ethernet-cfg:negotiation/auto/allow-overrides"))
	}
	if !state.NegotiationAuto.IsNull() && data.NegotiationAuto.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "Cisco-IOS-XR-um-if-ethernet-cfg:negotiation/auto"))
	}
	if !state.Fec.IsNull() && data.Fec.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "Cisco-IOS-XR-um-if-ethernet-cfg:fec"))
	}
	if !state.FlowControl.IsNull() && data.FlowControl.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "Cisco-IOS-XR-um-if-ethernet-cfg:flow-control"))
	}
	if !state.Duplex.IsNull() && data.Duplex.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "Cisco-IOS-XR-um-if-ethernet-cfg:duplex"))
	}
	if !state.Speed.IsNull() && data.Speed.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "Cisco-IOS-XR-um-if-ethernet-cfg:speed"))
	}
	...
	if !state.CarrierDelayDown.IsNull() && data.CarrierDelayDown.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "Cisco-IOS-XR-um-if-ethernet-cfg:carrier-delay/down"))
	}
	if !state.CarrierDelayUp.IsNull() && data.CarrierDelayUp.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "Cisco-IOS-XR-um-if-ethernet-cfg:carrier-delay/up"))
	}
	...
	if !state.BundlePortPriority.IsNull() && data.BundlePortPriority.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "Cisco-IOS-XR-um-if-bundle-cfg:bundle/port-priority"))
	}
	if !state.BundleIdMode.IsNull() && data.BundleIdMode.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "Cisco-IOS-XR-um-if-bundle-cfg:bundle/id/mode"))
	}
	if !state.BundleId.IsNull() && data.BundleId.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "Cisco-IOS-XR-um-if-bundle-cfg:bundle/id/bundle-id"))
	}
	if !state.Cdp.IsNull() && data.Cdp.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "Cisco-IOS-XR-um-cdp-cfg:cdp"))
	}
	...
	if !state.FrequencySynchronizationSelectionInput.IsNull() && data.FrequencySynchronizationSelectionInput.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency/synchronization/selection/input"))
	}
	if !state.FrequencySynchronizationWaitToRestore.IsNull() && data.FrequencySynchronizationWaitToRestore.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency/synchronization/wait-to-restore"))
	}
	if !state.FrequencySynchronizationQualityReceiveExactItuTOptionTwoGenerationTwo.IsNull() && data.FrequencySynchronizationQualityReceiveExactItuTOptionTwoGenerationTwo.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency/synchronization/quality/receive/exact/itu-t/option/two/generation/two"))
	}
	if !state.FrequencySynchronizationQualityReceiveExactItuTOptionTwoGenerationOne.IsNull() && data.FrequencySynchronizationQualityReceiveExactItuTOptionTwoGenerationOne.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency/synchronization/quality/receive/exact/itu-t/option/two/generation/one"))
	}
	if !state.FrequencySynchronizationQualityReceiveExactItuTOptionOne.IsNull() && data.FrequencySynchronizationQualityReceiveExactItuTOptionOne.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency/synchronization/quality/receive/exact/itu-t/option/one"))
	}
	if !state.FrequencySynchronizationQualityReceiveHighestItuTOptionTwoGenerationTwo.IsNull() && data.FrequencySynchronizationQualityReceiveHighestItuTOptionTwoGenerationTwo.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency/synchronization/quality/receive/highest/itu-t/option/two/generation/two"))
	}
	if !state.FrequencySynchronizationQualityReceiveHighestItuTOptionTwoGenerationOne.IsNull() && data.FrequencySynchronizationQualityReceiveHighestItuTOptionTwoGenerationOne.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency/synchronization/quality/receive/highest/itu-t/option/two/generation/one"))
	}
	if !state.FrequencySynchronizationQualityReceiveHighestItuTOptionOne.IsNull() && data.FrequencySynchronizationQualityReceiveHighestItuTOptionOne.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency/synchronization/quality/receive/highest/itu-t/option/one"))
	}
	if !state.FrequencySynchronizationQualityReceiveLowestItuTOptionTwoGenerationTwo.IsNull() && data.FrequencySynchronizationQualityReceiveLowestItuTOptionTwoGenerationTwo.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency/synchronization/quality/receive/lowest/itu-t/option/two/generation/two"))
	}
	if !state.FrequencySynchronizationQualityReceiveLowestItuTOptionTwoGenerationOne.IsNull() && data.FrequencySynchronizationQualityReceiveLowestItuTOptionTwoGenerationOne.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency/synchronization/quality/receive/lowest/itu-t/option/two/generation/one"))
	}
	if !state.FrequencySynchronizationQualityReceiveLowestItuTOptionOne.IsNull() && data.FrequencySynchronizationQualityReceiveLowestItuTOptionOne.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency/synchronization/quality/receive/lowest/itu-t/option/one"))
	}
	if !state.FrequencySynchronizationQualityTransmitExactItuTOptionTwoGenerationTwo.IsNull() && data.FrequencySynchronizationQualityTransmitExactItuTOptionTwoGenerationTwo.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency/synchronization/quality/transmit/exact/itu-t/option/two/generation/two"))
	}
	if !state.FrequencySynchronizationQualityTransmitExactItuTOptionTwoGenerationOne.IsNull() && data.FrequencySynchronizationQualityTransmitExactItuTOptionTwoGenerationOne.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency/synchronization/quality/transmit/exact/itu-t/option/two/generation/one"))
	}
	if !state.FrequencySynchronizationQualityTransmitExactItuTOptionOne.IsNull() && data.FrequencySynchronizationQualityTransmitExactItuTOptionOne.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency/synchronization/quality/transmit/exact/itu-t/option/one"))
	}
	if !state.FrequencySynchronizationQualityTransmitHighestItuTOptionTwoGenerationTwo.IsNull() && data.FrequencySynchronizationQualityTransmitHighestItuTOptionTwoGenerationTwo.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency/synchronization/quality/transmit/highest/itu-t/option/two/generation/two"))
	}
	if !state.FrequencySynchronizationQualityTransmitHighestItuTOptionTwoGenerationOne.IsNull() && data.FrequencySynchronizationQualityTransmitHighestItuTOptionTwoGenerationOne.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency/synchronization/quality/transmit/highest/itu-t/option/two/generation/one"))
	}
	if !state.FrequencySynchronizationQualityTransmitHighestItuTOptionOne.IsNull() && data.FrequencySynchronizationQualityTransmitHighestItuTOptionOne.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency/synchronization/quality/transmit/highest/itu-t/option/one"))
	}
	if !state.FrequencySynchronizationQualityTransmitLowestItuTOptionTwoGenerationTwo.IsNull() && data.FrequencySynchronizationQualityTransmitLowestItuTOptionTwoGenerationTwo.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency/synchronization/quality/transmit/lowest/itu-t/option/two/generation/two"))
	}
	if !state.FrequencySynchronizationQualityTransmitLowestItuTOptionTwoGenerationOne.IsNull() && data.FrequencySynchronizationQualityTransmitLowestItuTOptionTwoGenerationOne.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency/synchronization/quality/transmit/lowest/itu-t/option/two/generation/one"))
	}
	if !state.FrequencySynchronizationQualityTransmitLowestItuTOptionOne.IsNull() && data.FrequencySynchronizationQualityTransmitLowestItuTOptionOne.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency/synchronization/quality/transmit/lowest/itu-t/option/one"))
	}
	if !state.FrequencySynchronizationTimeOfDayPriority.IsNull() && data.FrequencySynchronizationTimeOfDayPriority.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency/synchronization/time-of-day-priority"))
	}
	if !state.FrequencySynchronizationPriority.IsNull() && data.FrequencySynchronizationPriority.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency/synchronization/priority"))
	}
	if !state.FrequencySynchronizationSsmDisable.IsNull() && data.FrequencySynchronizationSsmDisable.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency/synchronization/ssm/disable"))
	}
	if !state.FrequencySynchronization.IsNull() && data.FrequencySynchronization.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency/synchronization"))
	}
		...
		for j := range data.EthernetCfmMepDomains {
			...
			if found {
				...
				if !state.EthernetCfmMepDomains[i].LossMeasurementCountersPriorityCosValue7.IsNull() && data.EthernetCfmMepDomains[j].LossMeasurementCountersPriorityCosValue7.IsNull() {
					deletedItems = append(deletedItems, path.Join(fmt.Sprintf("%v/Cisco-IOS-XR-um-ethernet-cfm-cfg:ethernet/cfm/mep/domain%v", state.getPath(), keyString), "loss-measurement/counters/priority/cos-values/cos-value7"))
				}
				if !state.EthernetCfmMepDomains[i].LossMeasurementCountersPriorityCosValue6.IsNull() && data.EthernetCfmMepDomains[j].LossMeasurementCountersPriorityCosValue6.IsNull() {
					deletedItems = append(deletedItems, path.Join(fmt.Sprintf("%v/Cisco-IOS-XR-um-ethernet-cfm-cfg:ethernet/cfm/mep/domain%v", state.getPath(), keyString), "loss-measurement/counters/priority/cos-values/cos-value6"))
				}
				if !state.EthernetCfmMepDomains[i].LossMeasurementCountersPriorityCosValue5.IsNull() && data.EthernetCfmMepDomains[j].LossMeasurementCountersPriorityCosValue5.IsNull() {
					deletedItems = append(deletedItems, path.Join(fmt.Sprintf("%v/Cisco-IOS-XR-um-ethernet-cfm-cfg:ethernet/cfm/mep/domain%v", state.getPath(), keyString), "loss-measurement/counters/priority/cos-values/cos-value5"))
				}
				if !state.EthernetCfmMepDomains[i].LossMeasurementCountersPriorityCosValue4.IsNull() && data.EthernetCfmMepDomains[j].LossMeasurementCountersPriorityCosValue4.IsNull() {
					deletedItems = append(deletedItems, path.Join(fmt.Sprintf("%v/Cisco-IOS-XR-um-ethernet-cfm-cfg:ethernet/cfm/mep/domain%v", state.getPath(), keyString), "loss-measurement/counters/priority/cos-values/cos-value4"))
				}
				if !state.EthernetCfmMepDomains[i].LossMeasurementCountersPriorityCosValue3.IsNull() && data.EthernetCfmMepDomains[j].LossMeasurementCountersPriorityCosValue3.IsNull() {
					deletedItems = append(deletedItems, path.Join(fmt.Sprintf("%v/Cisco-IOS-XR-um-ethernet-cfm-cfg:ethernet/cfm/mep/domain%v", state.getPath(), keyString), "loss-measurement/counters/priority/cos-values/cos-value3"))
				}
				if !state.EthernetCfmMepDomains[i].LossMeasurementCountersPriorityCosValue2.IsNull() && data.EthernetCfmMepDomains[j].LossMeasurementCountersPriorityCosValue2.IsNull() {
					deletedItems = append(deletedItems, path.Join(fmt.Sprintf("%v/Cisco-IOS-XR-um-ethernet-cfm-cfg:ethernet/cfm/mep/domain%v", state.getPath(), keyString), "loss-measurement/counters/priority/cos-values/cos-value2"))
				}
				if !state.EthernetCfmMepDomains[i].LossMeasurementCountersPriorityCosValue1.IsNull() && data.EthernetCfmMepDomains[j].LossMeasurementCountersPriorityCosValue1.IsNull() {
					deletedItems = append(deletedItems, path.Join(fmt.Sprintf("%v/Cisco-IOS-XR-um-ethernet-cfm-cfg:ethernet/cfm/mep/domain%v", state.getPath(), keyString), "loss-measurement/counters/priority/cos-values/cos-value1"))
				}
				if !state.EthernetCfmMepDomains[i].LossMeasurementCountersPriorityCosRangeEnd.IsNull() && data.EthernetCfmMepDomains[j].LossMeasurementCountersPriorityCosRangeEnd.IsNull() {
					deletedItems = append(deletedItems, path.Join(fmt.Sprintf("%v/Cisco-IOS-XR-um-ethernet-cfm-cfg:ethernet/cfm/mep/domain%v", state.getPath(), keyString), "loss-measurement/counters/priority/cos-range/end-of-cos-range"))
				}
				if !state.EthernetCfmMepDomains[i].LossMeasurementCountersPriorityCosRangeStart.IsNull() && data.EthernetCfmMepDomains[j].LossMeasurementCountersPriorityCosRangeStart.IsNull() {
					deletedItems = append(deletedItems, path.Join(fmt.Sprintf("%v/Cisco-IOS-XR-um-ethernet-cfm-cfg:ethernet/cfm/mep/domain%v", state.getPath(), keyString), "loss-measurement/counters/priority/cos-range/start-of-cos-range"))
				}
				if !state.EthernetCfmMepDomains[i].LossMeasurementCountersAggregate.IsNull() && data.EthernetCfmMepDomains[j].LossMeasurementCountersAggregate.IsNull() {
					deletedItems = append(deletedItems, path.Join(fmt.Sprintf("%v/Cisco-IOS-XR-um-ethernet-cfm-cfg:ethernet/cfm/mep/domain%v", state.getPath(), keyString), "loss-measurement/counters/aggregate"))
				}
				if !state.EthernetCfmMepDomains[i].Cos.IsNull() && data.EthernetCfmMepDomains[j].Cos.IsNull() {
					deletedItems = append(deletedItems, path.Join(fmt.Sprintf("%v/Cisco-IOS-XR-um-ethernet-cfm-cfg:ethernet/cfm/mep/domain%v", state.getPath(), keyString), "cos"))
				}
				if !state.EthernetCfmMepDomains[i].PropagateRemoteStatus.IsNull() && data.EthernetCfmMepDomains[j].PropagateRemoteStatus.IsNull() {
					deletedItems = append(deletedItems, path.Join(fmt.Sprintf("%v/Cisco-IOS-XR-um-ethernet-cfm-cfg:ethernet/cfm/mep/domain%v", state.getPath(), keyString), "propagate-remote-status"))
				}
				if !state.EthernetCfmMepDomains[i].MepId.IsNull() && data.EthernetCfmMepDomains[j].MepId.IsNull() {
					deletedItems = append(deletedItems, path.Join(fmt.Sprintf("%v/Cisco-IOS-XR-um-ethernet-cfm-cfg:ethernet/cfm/mep/domain%v", state.getPath(), keyString), "mep-id"))
				}
				if !state.EthernetCfmMepDomains[i].Service.IsNull() && data.EthernetCfmMepDomains[j].Service.IsNull() {
					deletedItems = append(deletedItems, path.Join(fmt.Sprintf("%v/Cisco-IOS-XR-um-ethernet-cfm-cfg:ethernet/cfm/mep/domain%v", state.getPath(), keyString), "service"))
				}
				break
			}
		}
	...
	if !state.RewriteIngressTagPopTwo.IsNull() && data.RewriteIngressTagPopTwo.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "Cisco-IOS-XR-um-l2-ethernet-cfg:rewrite/ingress/tag/pop/two"))
	}
	if !state.RewriteIngressTagPopOne.IsNull() && data.RewriteIngressTagPopOne.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "Cisco-IOS-XR-um-l2-ethernet-cfg:rewrite/ingress/tag/pop/one"))
	}
	if !state.L2transportEncapsulationDot1qSecondDot1q.IsNull() && data.L2transportEncapsulationDot1qSecondDot1q.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "Cisco-IOS-XR-um-l2-ethernet-cfg:l2transport-encapsulation/dot1q/second-dot1q"))
	}
	if !state.L2transportEncapsulationDot1qVlanId.IsNull() && data.L2transportEncapsulationDot1qVlanId.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "Cisco-IOS-XR-um-l2-ethernet-cfg:l2transport-encapsulation/dot1q/vlan-id"))
	}
	...
	if !state.EncapsulationDot1qSecondDot1q.IsNull() && data.EncapsulationDot1qSecondDot1q.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "Cisco-IOS-XR-um-l2-ethernet-cfg:encapsulation/dot1q/second-dot1q"))
	}
	if !state.EncapsulationDot1qVlanId.IsNull() && data.EncapsulationDot1qVlanId.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "Cisco-IOS-XR-um-l2-ethernet-cfg:encapsulation/dot1q/vlan-id"))
	}
...
func (data *InterfaceEthernet) getEmptyLeafsDelete(ctx context.Context, version string) []string {
	...
	if !data.NegotiationAutoAllowOverrides.IsNull() && !data.NegotiationAutoAllowOverrides.ValueBool() {
		emptyLeafsDelete = append(emptyLeafsDelete, path.Join(data.getPath(), "Cisco-IOS-XR-um-if-ethernet-cfg:negotiation/auto/allow-overrides"))
	}
	if !data.NegotiationAuto.IsNull() && !data.NegotiationAuto.ValueBool() {
		emptyLeafsDelete = append(emptyLeafsDelete, path.Join(data.getPath(), "Cisco-IOS-XR-um-if-ethernet-cfg:negotiation/auto"))
	}
	...
	if !data.FrequencySynchronizationSelectionInput.IsNull() && !data.FrequencySynchronizationSelectionInput.ValueBool() {
		emptyLeafsDelete = append(emptyLeafsDelete, path.Join(data.getPath(), "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency/synchronization/selection/input"))
	}
	if !data.FrequencySynchronizationSsmDisable.IsNull() && !data.FrequencySynchronizationSsmDisable.ValueBool() {
		emptyLeafsDelete = append(emptyLeafsDelete, path.Join(data.getPath(), "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency/synchronization/ssm/disable"))
	}
	if !data.FrequencySynchronization.IsNull() && !data.FrequencySynchronization.ValueBool() {
		emptyLeafsDelete = append(emptyLeafsDelete, path.Join(data.getPath(), "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency/synchronization"))
	}
	for i := range data.FlowIpv6EgressMonitorSamplers {
		keys := [...]string{"monitor-map-name", "sampler-map-name"}
		keyValues := [...]string{data.FlowIpv6EgressMonitorSamplers[i].MonitorMapName.ValueString(), data.FlowIpv6EgressMonitorSamplers[i].SamplerMapName.ValueString()}
	...
	for i := range data.EthernetCfmMepDomains {
		...
		if !data.EthernetCfmMepDomains[i].LossMeasurementCountersAggregate.IsNull() && !data.EthernetCfmMepDomains[i].LossMeasurementCountersAggregate.ValueBool() {
			emptyLeafsDelete = append(emptyLeafsDelete, path.Join(fmt.Sprintf("%v/Cisco-IOS-XR-um-ethernet-cfm-cfg:ethernet/cfm/mep/domain%v", data.getPath(), keyString), "loss-measurement/counters/aggregate"))
		}
		if !data.EthernetCfmMepDomains[i].PropagateRemoteStatus.IsNull() && !data.EthernetCfmMepDomains[i].PropagateRemoteStatus.ValueBool() {
			emptyLeafsDelete = append(emptyLeafsDelete, path.Join(fmt.Sprintf("%v/Cisco-IOS-XR-um-ethernet-cfm-cfg:ethernet/cfm/mep/domain%v", data.getPath(), keyString), "propagate-remote-status"))
		}
	}
...
func (data *InterfaceEthernet) getDeletePaths(ctx context.Context, version string) []string {
	...
	if !data.LldpTagged.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "Cisco-IOS-XR-um-lldp-cfg:lldp/tagged"))
	}
	...
	if !data.NegotiationAutoAllowOverrides.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "Cisco-IOS-XR-um-if-ethernet-cfg:negotiation/auto/allow-overrides"))
	}
	if !data.NegotiationAuto.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "Cisco-IOS-XR-um-if-ethernet-cfg:negotiation/auto"))
	}
	if !data.Fec.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "Cisco-IOS-XR-um-if-ethernet-cfg:fec"))
	}
	if !data.FlowControl.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "Cisco-IOS-XR-um-if-ethernet-cfg:flow-control"))
	}
	if !data.Duplex.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "Cisco-IOS-XR-um-if-ethernet-cfg:duplex"))
	}
	if !data.Speed.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "Cisco-IOS-XR-um-if-ethernet-cfg:speed"))
	}
	...
	if !data.CarrierDelayDown.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "Cisco-IOS-XR-um-if-ethernet-cfg:carrier-delay/down"))
	}
	if !data.CarrierDelayUp.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "Cisco-IOS-XR-um-if-ethernet-cfg:carrier-delay/up"))
	}
	...
	if !data.BundlePortPriority.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "Cisco-IOS-XR-um-if-bundle-cfg:bundle/port-priority"))
	}
	if !data.BundleIdMode.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "Cisco-IOS-XR-um-if-bundle-cfg:bundle/id/mode"))
	}
	if !data.BundleId.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "Cisco-IOS-XR-um-if-bundle-cfg:bundle/id/bundle-id"))
	}
	if !data.Cdp.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "Cisco-IOS-XR-um-cdp-cfg:cdp"))
	}
	...
	if !data.FrequencySynchronizationSelectionInput.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency/synchronization/selection/input"))
	}
	if !data.FrequencySynchronizationWaitToRestore.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency/synchronization/wait-to-restore"))
	}
	if !data.FrequencySynchronizationQualityReceiveExactItuTOptionTwoGenerationTwo.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency/synchronization/quality/receive/exact/itu-t/option/two/generation/two"))
	}
	if !data.FrequencySynchronizationQualityReceiveExactItuTOptionTwoGenerationOne.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency/synchronization/quality/receive/exact/itu-t/option/two/generation/one"))
	}
	if !data.FrequencySynchronizationQualityReceiveExactItuTOptionOne.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency/synchronization/quality/receive/exact/itu-t/option/one"))
	}
	if !data.FrequencySynchronizationQualityReceiveHighestItuTOptionTwoGenerationTwo.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency/synchronization/quality/receive/highest/itu-t/option/two/generation/two"))
	}
	if !data.FrequencySynchronizationQualityReceiveHighestItuTOptionTwoGenerationOne.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency/synchronization/quality/receive/highest/itu-t/option/two/generation/one"))
	}
	if !data.FrequencySynchronizationQualityReceiveHighestItuTOptionOne.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency/synchronization/quality/receive/highest/itu-t/option/one"))
	}
	if !data.FrequencySynchronizationQualityReceiveLowestItuTOptionTwoGenerationTwo.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency/synchronization/quality/receive/lowest/itu-t/option/two/generation/two"))
	}
	if !data.FrequencySynchronizationQualityReceiveLowestItuTOptionTwoGenerationOne.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency/synchronization/quality/receive/lowest/itu-t/option/two/generation/one"))
	}
	if !data.FrequencySynchronizationQualityReceiveLowestItuTOptionOne.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency/synchronization/quality/receive/lowest/itu-t/option/one"))
	}
	if !data.FrequencySynchronizationQualityTransmitExactItuTOptionTwoGenerationTwo.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency/synchronization/quality/transmit/exact/itu-t/option/two/generation/two"))
	}
	if !data.FrequencySynchronizationQualityTransmitExactItuTOptionTwoGenerationOne.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency/synchronization/quality/transmit/exact/itu-t/option/two/generation/one"))
	}
	if !data.FrequencySynchronizationQualityTransmitExactItuTOptionOne.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency/synchronization/quality/transmit/exact/itu-t/option/one"))
	}
	if !data.FrequencySynchronizationQualityTransmitHighestItuTOptionTwoGenerationTwo.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency/synchronization/quality/transmit/highest/itu-t/option/two/generation/two"))
	}
	if !data.FrequencySynchronizationQualityTransmitHighestItuTOptionTwoGenerationOne.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency/synchronization/quality/transmit/highest/itu-t/option/two/generation/one"))
	}
	if !data.FrequencySynchronizationQualityTransmitHighestItuTOptionOne.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency/synchronization/quality/transmit/highest/itu-t/option/one"))
	}
	if !data.FrequencySynchronizationQualityTransmitLowestItuTOptionTwoGenerationTwo.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency/synchronization/quality/transmit/lowest/itu-t/option/two/generation/two"))
	}
	if !data.FrequencySynchronizationQualityTransmitLowestItuTOptionTwoGenerationOne.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency/synchronization/quality/transmit/lowest/itu-t/option/two/generation/one"))
	}
	if !data.FrequencySynchronizationQualityTransmitLowestItuTOptionOne.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency/synchronization/quality/transmit/lowest/itu-t/option/one"))
	}
	if !data.FrequencySynchronizationTimeOfDayPriority.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency/synchronization/time-of-day-priority"))
	}
	if !data.FrequencySynchronizationPriority.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency/synchronization/priority"))
	}
	if !data.FrequencySynchronizationSsmDisable.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency/synchronization/ssm/disable"))
	}
	if !data.FrequencySynchronization.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "Cisco-IOS-XR-um-frequency-synchronization-cfg:frequency/synchronization"))
	}
	for i := range data.FlowIpv6EgressMonitorSamplers {
		keys := [...]string{"monitor-map-name", "sampler-map-name"}
		keyValues := [...]string{data.FlowIpv6EgressMonitorSamplers[i].MonitorMapName.ValueString(), data.FlowIpv6EgressMonitorSamplers[i].SamplerMapName.ValueString()}
	...
	if !data.RewriteIngressTagPopTwo.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "Cisco-IOS-XR-um-l2-ethernet-cfg:rewrite/ingress/tag/pop/two"))
	}
	if !data.RewriteIngressTagPopOne.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "Cisco-IOS-XR-um-l2-ethernet-cfg:rewrite/ingress/tag/pop/one"))
	}
	if !data.L2transportEncapsulationDot1qSecondDot1q.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "Cisco-IOS-XR-um-l2-ethernet-cfg:l2transport-encapsulation/dot1q/second-dot1q"))
	}
	if !data.L2transportEncapsulationDot1qVlanId.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "Cisco-IOS-XR-um-l2-ethernet-cfg:l2transport-encapsulation/dot1q/vlan-id"))
	}
	...
	if !data.EncapsulationDot1qSecondDot1q.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "Cisco-IOS-XR-um-l2-ethernet-cfg:encapsulation/dot1q/second-dot1q"))
	}
	if !data.EncapsulationDot1qVlanId.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "Cisco-IOS-XR-um-l2-ethernet-cfg:encapsulation/dot1q/vlan-id"))
	}
	for i := range data.ServicePolicyOutput {
		keys := [...]string{"service-policy-name"}
		keyValues := [...]string{data.ServicePolicyOutput[i].Name.ValueString()}
