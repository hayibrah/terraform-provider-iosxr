...
func (data RouterStaticIPv4Multicast) GetEnumConstraints() []helpers.FieldEnumConstraint {
	return nil
}
...
func (data RouterStaticIPv4Multicast) GetStringLengthConstraints() []helpers.FieldStringLengthConstraint {
	return nil
}
...
func (data RouterStaticIPv4Multicast) GetPatternConstraints() []helpers.FieldPatternConstraint {
	return nil
}
...
func (data *RouterStaticIPv4Multicast) fromBody(ctx context.Context, res []byte, version string) {
...
func (data *RouterStaticIPv4MulticastData) fromBody(ctx context.Context, res []byte, version string) {
	if value := gjson.GetBytes(res, "nexthop-interfaces.nexthop-interface"); value.Exists() {
		data.NexthopInterfaces = make([]RouterStaticIPv4MulticastNexthopInterfaces, 0)
		value.ForEach(func(k, v gjson.Result) bool {
			item := RouterStaticIPv4MulticastNexthopInterfaces{}
...
func (data *RouterStaticIPv4Multicast) getDeletedItems(ctx context.Context, state RouterStaticIPv4Multicast, version string) []string {
...
func (data *RouterStaticIPv4Multicast) getEmptyLeafsDelete(ctx context.Context, version string) []string {
...
func (data *RouterStaticIPv4Multicast) getDeletePaths(ctx context.Context, version string) []string {
