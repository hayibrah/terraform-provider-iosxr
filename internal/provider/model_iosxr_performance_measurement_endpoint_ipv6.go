...
func (data PerformanceMeasurementEndpointIPv6) GetEnumConstraints() []helpers.FieldEnumConstraint {
	return nil
}
...
func (data PerformanceMeasurementEndpointIPv6) GetStringLengthConstraints() []helpers.FieldStringLengthConstraint {
	return nil
}
...
func (data PerformanceMeasurementEndpointIPv6) GetPatternConstraints() []helpers.FieldPatternConstraint {
	return nil
}
...
func (data *PerformanceMeasurementEndpointIPv6) fromBody(ctx context.Context, res []byte, version string) {
...
func (data *PerformanceMeasurementEndpointIPv6Data) fromBody(ctx context.Context, res []byte, version string) {
	if value := gjson.GetBytes(res, "source-address.ipv6"); value.Exists() && value.Type == gjson.String {
		data.SourceAddressIpv6 = types.StringValue(value.String())
	}
	if value := gjson.GetBytes(res, "description"); value.Exists() && value.Type == gjson.String {
...
func (data *PerformanceMeasurementEndpointIPv6) getDeletedItems(ctx context.Context, state PerformanceMeasurementEndpointIPv6, version string) []string {
...
func (data *PerformanceMeasurementEndpointIPv6) getEmptyLeafsDelete(ctx context.Context, version string) []string {
...
func (data *PerformanceMeasurementEndpointIPv6) getDeletePaths(ctx context.Context, version string) []string {
