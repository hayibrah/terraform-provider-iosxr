...
func (data ControlPlane) GetEnumConstraints() []helpers.FieldEnumConstraint {
	return nil
}
...
func (data ControlPlane) GetStringLengthConstraints() []helpers.FieldStringLengthConstraint {
	return nil
}
...
func (data ControlPlane) GetPatternConstraints() []helpers.FieldPatternConstraint {
	return nil
}
...
func (data *ControlPlane) updateFromBody(ctx context.Context, res []byte, version string) {
	for i := range data.MgmtInbandInterfaces {
		...
		if value := r.Get("interface-name"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtInbandInterfaces[i].InterfaceName.IsNull() {
		...
		for ci := range data.MgmtInbandInterfaces[i].SshIpv4Prefixes {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtInbandInterfaces[i].SshIpv4Prefixes[ci].Address.IsNull() {
		...
		for ci := range data.MgmtInbandInterfaces[i].SshIpv4Hosts {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtInbandInterfaces[i].SshIpv4Hosts[ci].Address.IsNull() {
		...
		for ci := range data.MgmtInbandInterfaces[i].SshIpv6Prefixes {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtInbandInterfaces[i].SshIpv6Prefixes[ci].Address.IsNull() {
		...
		for ci := range data.MgmtInbandInterfaces[i].SshIpv6Hosts {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtInbandInterfaces[i].SshIpv6Hosts[ci].Address.IsNull() {
		...
		for ci := range data.MgmtInbandInterfaces[i].TelnetIpv4Prefixes {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtInbandInterfaces[i].TelnetIpv4Prefixes[ci].Address.IsNull() {
		...
		for ci := range data.MgmtInbandInterfaces[i].TelnetIpv4Hosts {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtInbandInterfaces[i].TelnetIpv4Hosts[ci].Address.IsNull() {
		...
		for ci := range data.MgmtInbandInterfaces[i].TelnetIpv6Prefixes {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtInbandInterfaces[i].TelnetIpv6Prefixes[ci].Address.IsNull() {
		...
		for ci := range data.MgmtInbandInterfaces[i].TelnetIpv6Hosts {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtInbandInterfaces[i].TelnetIpv6Hosts[ci].Address.IsNull() {
		...
		for ci := range data.MgmtInbandInterfaces[i].SnmpIpv4Prefixes {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtInbandInterfaces[i].SnmpIpv4Prefixes[ci].Address.IsNull() {
		...
		for ci := range data.MgmtInbandInterfaces[i].SnmpIpv4Hosts {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtInbandInterfaces[i].SnmpIpv4Hosts[ci].Address.IsNull() {
		...
		for ci := range data.MgmtInbandInterfaces[i].SnmpIpv6Prefixes {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtInbandInterfaces[i].SnmpIpv6Prefixes[ci].Address.IsNull() {
		...
		for ci := range data.MgmtInbandInterfaces[i].SnmpIpv6Hosts {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtInbandInterfaces[i].SnmpIpv6Hosts[ci].Address.IsNull() {
		...
		for ci := range data.MgmtInbandInterfaces[i].TftpIpv4Prefixes {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtInbandInterfaces[i].TftpIpv4Prefixes[ci].Address.IsNull() {
		...
		for ci := range data.MgmtInbandInterfaces[i].TftpIpv4Hosts {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtInbandInterfaces[i].TftpIpv4Hosts[ci].Address.IsNull() {
		...
		for ci := range data.MgmtInbandInterfaces[i].TftpIpv6Prefixes {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtInbandInterfaces[i].TftpIpv6Prefixes[ci].Address.IsNull() {
		...
		for ci := range data.MgmtInbandInterfaces[i].TftpIpv6Hosts {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtInbandInterfaces[i].TftpIpv6Hosts[ci].Address.IsNull() {
		...
		for ci := range data.MgmtInbandInterfaces[i].HttpIpv4Prefixes {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtInbandInterfaces[i].HttpIpv4Prefixes[ci].Address.IsNull() {
		...
		for ci := range data.MgmtInbandInterfaces[i].HttpIpv4Hosts {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtInbandInterfaces[i].HttpIpv4Hosts[ci].Address.IsNull() {
		...
		for ci := range data.MgmtInbandInterfaces[i].XmlIpv4Prefixes {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtInbandInterfaces[i].XmlIpv4Prefixes[ci].Address.IsNull() {
		...
		for ci := range data.MgmtInbandInterfaces[i].XmlIpv4Hosts {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtInbandInterfaces[i].XmlIpv4Hosts[ci].Address.IsNull() {
		...
		for ci := range data.MgmtInbandInterfaces[i].XmlIpv6Prefixes {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtInbandInterfaces[i].XmlIpv6Prefixes[ci].Address.IsNull() {
		...
		for ci := range data.MgmtInbandInterfaces[i].XmlIpv6Hosts {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtInbandInterfaces[i].XmlIpv6Hosts[ci].Address.IsNull() {
		...
		for ci := range data.MgmtInbandInterfaces[i].NetconfIpv4Prefixes {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtInbandInterfaces[i].NetconfIpv4Prefixes[ci].Address.IsNull() {
		...
		for ci := range data.MgmtInbandInterfaces[i].NetconfIpv4Hosts {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtInbandInterfaces[i].NetconfIpv4Hosts[ci].Address.IsNull() {
		...
		for ci := range data.MgmtInbandInterfaces[i].NetconfIpv6Prefixes {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtInbandInterfaces[i].NetconfIpv6Prefixes[ci].Address.IsNull() {
		...
		for ci := range data.MgmtInbandInterfaces[i].NetconfIpv6Hosts {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtInbandInterfaces[i].NetconfIpv6Hosts[ci].Address.IsNull() {
		...
		for ci := range data.MgmtInbandInterfaces[i].AllowAllIpv4Prefixes {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtInbandInterfaces[i].AllowAllIpv4Prefixes[ci].Address.IsNull() {
		...
		for ci := range data.MgmtInbandInterfaces[i].AllowAllIpv4Hosts {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtInbandInterfaces[i].AllowAllIpv4Hosts[ci].Address.IsNull() {
		...
		for ci := range data.MgmtInbandInterfaces[i].AllowAllIpv6Prefixes {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtInbandInterfaces[i].AllowAllIpv6Prefixes[ci].Address.IsNull() {
		...
		for ci := range data.MgmtInbandInterfaces[i].AllowAllIpv6Hosts {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtInbandInterfaces[i].AllowAllIpv6Hosts[ci].Address.IsNull() {
	...
	for i := range data.MgmtInbandAllSshIpv4Prefixes {
		...
		if value := r.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtInbandAllSshIpv4Prefixes[i].Address.IsNull() {
	...
	for i := range data.MgmtInbandAllSshIpv4Hosts {
		...
		if value := r.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtInbandAllSshIpv4Hosts[i].Address.IsNull() {
	...
	for i := range data.MgmtInbandAllSshIpv6Prefixes {
		...
		if value := r.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtInbandAllSshIpv6Prefixes[i].Address.IsNull() {
	...
	for i := range data.MgmtInbandAllSshIpv6Hosts {
		...
		if value := r.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtInbandAllSshIpv6Hosts[i].Address.IsNull() {
	...
	for i := range data.MgmtInbandAllTelnetIpv4Prefixes {
		...
		if value := r.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtInbandAllTelnetIpv4Prefixes[i].Address.IsNull() {
	...
	for i := range data.MgmtInbandAllTelnetIpv4Hosts {
		...
		if value := r.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtInbandAllTelnetIpv4Hosts[i].Address.IsNull() {
	...
	for i := range data.MgmtInbandAllTelnetIpv6Prefixes {
		...
		if value := r.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtInbandAllTelnetIpv6Prefixes[i].Address.IsNull() {
	...
	for i := range data.MgmtInbandAllTelnetIpv6Hosts {
		...
		if value := r.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtInbandAllTelnetIpv6Hosts[i].Address.IsNull() {
	...
	for i := range data.MgmtInbandAllSnmpIpv4Prefixes {
		...
		if value := r.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtInbandAllSnmpIpv4Prefixes[i].Address.IsNull() {
	...
	for i := range data.MgmtInbandAllSnmpIpv4Hosts {
		...
		if value := r.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtInbandAllSnmpIpv4Hosts[i].Address.IsNull() {
	...
	for i := range data.MgmtInbandAllSnmpIpv6Prefixes {
		...
		if value := r.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtInbandAllSnmpIpv6Prefixes[i].Address.IsNull() {
	...
	for i := range data.MgmtInbandAllSnmpIpv6Hosts {
		...
		if value := r.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtInbandAllSnmpIpv6Hosts[i].Address.IsNull() {
	...
	for i := range data.MgmtInbandAllTftpIpv4Prefixes {
		...
		if value := r.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtInbandAllTftpIpv4Prefixes[i].Address.IsNull() {
	...
	for i := range data.MgmtInbandAllTftpIpv4Hosts {
		...
		if value := r.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtInbandAllTftpIpv4Hosts[i].Address.IsNull() {
	...
	for i := range data.MgmtInbandAllTftpIpv6Prefixes {
		...
		if value := r.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtInbandAllTftpIpv6Prefixes[i].Address.IsNull() {
	...
	for i := range data.MgmtInbandAllTftpIpv6Hosts {
		...
		if value := r.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtInbandAllTftpIpv6Hosts[i].Address.IsNull() {
	...
	for i := range data.MgmtInbandAllHttpIpv4Prefixes {
		...
		if value := r.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtInbandAllHttpIpv4Prefixes[i].Address.IsNull() {
	...
	for i := range data.MgmtInbandAllHttpIpv4Hosts {
		...
		if value := r.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtInbandAllHttpIpv4Hosts[i].Address.IsNull() {
	...
	for i := range data.MgmtInbandAllXmlIpv4Prefixes {
		...
		if value := r.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtInbandAllXmlIpv4Prefixes[i].Address.IsNull() {
	...
	for i := range data.MgmtInbandAllXmlIpv4Hosts {
		...
		if value := r.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtInbandAllXmlIpv4Hosts[i].Address.IsNull() {
	...
	for i := range data.MgmtInbandAllXmlIpv6Prefixes {
		...
		if value := r.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtInbandAllXmlIpv6Prefixes[i].Address.IsNull() {
	...
	for i := range data.MgmtInbandAllXmlIpv6Hosts {
		...
		if value := r.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtInbandAllXmlIpv6Hosts[i].Address.IsNull() {
	...
	for i := range data.MgmtInbandAllNetconfIpv4Prefixes {
		...
		if value := r.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtInbandAllNetconfIpv4Prefixes[i].Address.IsNull() {
	...
	for i := range data.MgmtInbandAllNetconfIpv4Hosts {
		...
		if value := r.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtInbandAllNetconfIpv4Hosts[i].Address.IsNull() {
	...
	for i := range data.MgmtInbandAllNetconfIpv6Prefixes {
		...
		if value := r.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtInbandAllNetconfIpv6Prefixes[i].Address.IsNull() {
	...
	for i := range data.MgmtInbandAllNetconfIpv6Hosts {
		...
		if value := r.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtInbandAllNetconfIpv6Hosts[i].Address.IsNull() {
	...
	for i := range data.MgmtInbandAllAllowAllIpv4Prefixes {
		...
		if value := r.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtInbandAllAllowAllIpv4Prefixes[i].Address.IsNull() {
	...
	for i := range data.MgmtInbandAllAllowAllIpv4Hosts {
		...
		if value := r.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtInbandAllAllowAllIpv4Hosts[i].Address.IsNull() {
	...
	for i := range data.MgmtInbandAllAllowAllIpv6Prefixes {
		...
		if value := r.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtInbandAllAllowAllIpv6Prefixes[i].Address.IsNull() {
	...
	for i := range data.MgmtInbandAllAllowAllIpv6Hosts {
		...
		if value := r.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtInbandAllAllowAllIpv6Hosts[i].Address.IsNull() {
	...
	for i := range data.MgmtOobInterfaces {
		...
		if value := r.Get("interface-name"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtOobInterfaces[i].InterfaceName.IsNull() {
		...
		for ci := range data.MgmtOobInterfaces[i].SshIpv4Prefixes {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtOobInterfaces[i].SshIpv4Prefixes[ci].Address.IsNull() {
		...
		for ci := range data.MgmtOobInterfaces[i].SshIpv4Hosts {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtOobInterfaces[i].SshIpv4Hosts[ci].Address.IsNull() {
		...
		for ci := range data.MgmtOobInterfaces[i].SshIpv6Prefixes {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtOobInterfaces[i].SshIpv6Prefixes[ci].Address.IsNull() {
		...
		for ci := range data.MgmtOobInterfaces[i].SshIpv6Hosts {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtOobInterfaces[i].SshIpv6Hosts[ci].Address.IsNull() {
		...
		for ci := range data.MgmtOobInterfaces[i].TelnetIpv4Prefixes {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtOobInterfaces[i].TelnetIpv4Prefixes[ci].Address.IsNull() {
		...
		for ci := range data.MgmtOobInterfaces[i].TelnetIpv4Hosts {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtOobInterfaces[i].TelnetIpv4Hosts[ci].Address.IsNull() {
		...
		for ci := range data.MgmtOobInterfaces[i].TelnetIpv6Prefixes {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtOobInterfaces[i].TelnetIpv6Prefixes[ci].Address.IsNull() {
		...
		for ci := range data.MgmtOobInterfaces[i].TelnetIpv6Hosts {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtOobInterfaces[i].TelnetIpv6Hosts[ci].Address.IsNull() {
		...
		for ci := range data.MgmtOobInterfaces[i].SnmpIpv4Prefixes {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtOobInterfaces[i].SnmpIpv4Prefixes[ci].Address.IsNull() {
		...
		for ci := range data.MgmtOobInterfaces[i].SnmpIpv4Hosts {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtOobInterfaces[i].SnmpIpv4Hosts[ci].Address.IsNull() {
		...
		for ci := range data.MgmtOobInterfaces[i].SnmpIpv6Prefixes {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtOobInterfaces[i].SnmpIpv6Prefixes[ci].Address.IsNull() {
		...
		for ci := range data.MgmtOobInterfaces[i].SnmpIpv6Hosts {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtOobInterfaces[i].SnmpIpv6Hosts[ci].Address.IsNull() {
		...
		for ci := range data.MgmtOobInterfaces[i].TftpIpv4Prefixes {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtOobInterfaces[i].TftpIpv4Prefixes[ci].Address.IsNull() {
		...
		for ci := range data.MgmtOobInterfaces[i].TftpIpv4Hosts {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtOobInterfaces[i].TftpIpv4Hosts[ci].Address.IsNull() {
		...
		for ci := range data.MgmtOobInterfaces[i].TftpIpv6Prefixes {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtOobInterfaces[i].TftpIpv6Prefixes[ci].Address.IsNull() {
		...
		for ci := range data.MgmtOobInterfaces[i].TftpIpv6Hosts {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtOobInterfaces[i].TftpIpv6Hosts[ci].Address.IsNull() {
		...
		for ci := range data.MgmtOobInterfaces[i].HttpIpv4Prefixes {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtOobInterfaces[i].HttpIpv4Prefixes[ci].Address.IsNull() {
		...
		for ci := range data.MgmtOobInterfaces[i].HttpIpv4Hosts {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtOobInterfaces[i].HttpIpv4Hosts[ci].Address.IsNull() {
		...
		for ci := range data.MgmtOobInterfaces[i].XmlIpv4Prefixes {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtOobInterfaces[i].XmlIpv4Prefixes[ci].Address.IsNull() {
		...
		for ci := range data.MgmtOobInterfaces[i].XmlIpv4Hosts {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtOobInterfaces[i].XmlIpv4Hosts[ci].Address.IsNull() {
		...
		for ci := range data.MgmtOobInterfaces[i].XmlIpv6Prefixes {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtOobInterfaces[i].XmlIpv6Prefixes[ci].Address.IsNull() {
		...
		for ci := range data.MgmtOobInterfaces[i].XmlIpv6Hosts {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtOobInterfaces[i].XmlIpv6Hosts[ci].Address.IsNull() {
		...
		for ci := range data.MgmtOobInterfaces[i].NetconfIpv4Prefixes {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtOobInterfaces[i].NetconfIpv4Prefixes[ci].Address.IsNull() {
		...
		for ci := range data.MgmtOobInterfaces[i].NetconfIpv4Hosts {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtOobInterfaces[i].NetconfIpv4Hosts[ci].Address.IsNull() {
		...
		for ci := range data.MgmtOobInterfaces[i].NetconfIpv6Prefixes {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtOobInterfaces[i].NetconfIpv6Prefixes[ci].Address.IsNull() {
		...
		for ci := range data.MgmtOobInterfaces[i].NetconfIpv6Hosts {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtOobInterfaces[i].NetconfIpv6Hosts[ci].Address.IsNull() {
		...
		for ci := range data.MgmtOobInterfaces[i].AllowAllIpv4Prefixes {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtOobInterfaces[i].AllowAllIpv4Prefixes[ci].Address.IsNull() {
		...
		for ci := range data.MgmtOobInterfaces[i].AllowAllIpv4Hosts {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtOobInterfaces[i].AllowAllIpv4Hosts[ci].Address.IsNull() {
		...
		for ci := range data.MgmtOobInterfaces[i].AllowAllIpv6Prefixes {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtOobInterfaces[i].AllowAllIpv6Prefixes[ci].Address.IsNull() {
		...
		for ci := range data.MgmtOobInterfaces[i].AllowAllIpv6Hosts {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtOobInterfaces[i].AllowAllIpv6Hosts[ci].Address.IsNull() {
	...
	if value := gjson.GetBytes(res, "management-plane.out-of-band.vrf"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtOobVrf.IsNull() {
	...
	for i := range data.MgmtOobAllSshIpv4Prefixes {
		...
		if value := r.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtOobAllSshIpv4Prefixes[i].Address.IsNull() {
	...
	for i := range data.MgmtOobAllSshIpv4Hosts {
		...
		if value := r.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtOobAllSshIpv4Hosts[i].Address.IsNull() {
	...
	for i := range data.MgmtOobAllSshIpv6Prefixes {
		...
		if value := r.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtOobAllSshIpv6Prefixes[i].Address.IsNull() {
	...
	for i := range data.MgmtOobAllSshIpv6Hosts {
		...
		if value := r.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtOobAllSshIpv6Hosts[i].Address.IsNull() {
	...
	for i := range data.MgmtOobAllTelnetIpv4Prefixes {
		...
		if value := r.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtOobAllTelnetIpv4Prefixes[i].Address.IsNull() {
	...
	for i := range data.MgmtOobAllTelnetIpv4Hosts {
		...
		if value := r.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtOobAllTelnetIpv4Hosts[i].Address.IsNull() {
	...
	for i := range data.MgmtOobAllTelnetIpv6Prefixes {
		...
		if value := r.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtOobAllTelnetIpv6Prefixes[i].Address.IsNull() {
	...
	for i := range data.MgmtOobAllTelnetIpv6Hosts {
		...
		if value := r.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtOobAllTelnetIpv6Hosts[i].Address.IsNull() {
	...
	for i := range data.MgmtOobAllSnmpIpv4Prefixes {
		...
		if value := r.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtOobAllSnmpIpv4Prefixes[i].Address.IsNull() {
	...
	for i := range data.MgmtOobAllSnmpIpv4Hosts {
		...
		if value := r.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtOobAllSnmpIpv4Hosts[i].Address.IsNull() {
	...
	for i := range data.MgmtOobAllSnmpIpv6Prefixes {
		...
		if value := r.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtOobAllSnmpIpv6Prefixes[i].Address.IsNull() {
	...
	for i := range data.MgmtOobAllSnmpIpv6Hosts {
		...
		if value := r.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtOobAllSnmpIpv6Hosts[i].Address.IsNull() {
	...
	for i := range data.MgmtOobAllTftpIpv4Prefixes {
		...
		if value := r.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtOobAllTftpIpv4Prefixes[i].Address.IsNull() {
	...
	for i := range data.MgmtOobAllTftpIpv4Hosts {
		...
		if value := r.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtOobAllTftpIpv4Hosts[i].Address.IsNull() {
	...
	for i := range data.MgmtOobAllTftpIpv6Prefixes {
		...
		if value := r.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtOobAllTftpIpv6Prefixes[i].Address.IsNull() {
	...
	for i := range data.MgmtOobAllTftpIpv6Hosts {
		...
		if value := r.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtOobAllTftpIpv6Hosts[i].Address.IsNull() {
	...
	for i := range data.MgmtOobAllHttpIpv4Prefixes {
		...
		if value := r.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtOobAllHttpIpv4Prefixes[i].Address.IsNull() {
	...
	for i := range data.MgmtOobAllHttpIpv4Hosts {
		...
		if value := r.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtOobAllHttpIpv4Hosts[i].Address.IsNull() {
	...
	for i := range data.MgmtOobAllXmlIpv4Prefixes {
		...
		if value := r.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtOobAllXmlIpv4Prefixes[i].Address.IsNull() {
	...
	for i := range data.MgmtOobAllXmlIpv4Hosts {
		...
		if value := r.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtOobAllXmlIpv4Hosts[i].Address.IsNull() {
	...
	for i := range data.MgmtOobAllXmlIpv6Prefixes {
		...
		if value := r.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtOobAllXmlIpv6Prefixes[i].Address.IsNull() {
	...
	for i := range data.MgmtOobAllXmlIpv6Hosts {
		...
		if value := r.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtOobAllXmlIpv6Hosts[i].Address.IsNull() {
	...
	for i := range data.MgmtOobAllNetconfIpv4Prefixes {
		...
		if value := r.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtOobAllNetconfIpv4Prefixes[i].Address.IsNull() {
	...
	for i := range data.MgmtOobAllNetconfIpv4Hosts {
		...
		if value := r.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtOobAllNetconfIpv4Hosts[i].Address.IsNull() {
	...
	for i := range data.MgmtOobAllNetconfIpv6Prefixes {
		...
		if value := r.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtOobAllNetconfIpv6Prefixes[i].Address.IsNull() {
	...
	for i := range data.MgmtOobAllNetconfIpv6Hosts {
		...
		if value := r.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtOobAllNetconfIpv6Hosts[i].Address.IsNull() {
	...
	for i := range data.MgmtOobAllAllowAllIpv4Prefixes {
		...
		if value := r.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtOobAllAllowAllIpv4Prefixes[i].Address.IsNull() {
	...
	for i := range data.MgmtOobAllAllowAllIpv4Hosts {
		...
		if value := r.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtOobAllAllowAllIpv4Hosts[i].Address.IsNull() {
	...
	for i := range data.MgmtOobAllAllowAllIpv6Prefixes {
		...
		if value := r.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtOobAllAllowAllIpv6Prefixes[i].Address.IsNull() {
	...
	for i := range data.MgmtOobAllAllowAllIpv6Hosts {
		...
		if value := r.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.MgmtOobAllAllowAllIpv6Hosts[i].Address.IsNull() {
...
func (data *ControlPlane) fromBody(ctx context.Context, res []byte, version string) {
	...
	if value := gjson.GetBytes(res, "management-plane.out-of-band.vrf"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) {
		data.MgmtOobVrf = types.StringValue(value.String())
	}
...
func (data *ControlPlane) getDeletedItems(ctx context.Context, state ControlPlane, version string) []string {
	...
	if !state.MgmtOobAllAllowAll.IsNull() && data.MgmtOobAllAllowAll.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "management-plane/out-of-band/interfaces/all/allow/all"))
	}
	...
	if !state.MgmtOobAllNetconf.IsNull() && data.MgmtOobAllNetconf.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "management-plane/out-of-band/interfaces/all/allow/netconf"))
	}
	...
	if !state.MgmtOobAllXml.IsNull() && data.MgmtOobAllXml.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "management-plane/out-of-band/interfaces/all/allow/xr-xml"))
	}
	...
	if !state.MgmtOobAllHttp.IsNull() && data.MgmtOobAllHttp.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "management-plane/out-of-band/interfaces/all/allow/http"))
	}
	...
	if !state.MgmtOobAllTftp.IsNull() && data.MgmtOobAllTftp.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "management-plane/out-of-band/interfaces/all/allow/tftp"))
	}
	...
	if !state.MgmtOobAllSnmp.IsNull() && data.MgmtOobAllSnmp.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "management-plane/out-of-band/interfaces/all/allow/snmp"))
	}
	...
	if !state.MgmtOobAllTelnet.IsNull() && data.MgmtOobAllTelnet.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "management-plane/out-of-band/interfaces/all/allow/telnet"))
	}
	...
	if !state.MgmtOobAllSsh.IsNull() && data.MgmtOobAllSsh.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "management-plane/out-of-band/interfaces/all/allow/ssh"))
	}
	if !state.MgmtOobInbandBehavior.IsNull() && data.MgmtOobInbandBehavior.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "management-plane/out-of-band/enable-inband-behavior"))
	}
	if !state.MgmtOobVrf.IsNull() && data.MgmtOobVrf.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "management-plane/out-of-band/vrf"))
	}
	...
	if !state.MgmtInbandAllAllowAll.IsNull() && data.MgmtInbandAllAllowAll.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "management-plane/inband/interfaces/all/allow/all"))
	}
	...
	if !state.MgmtInbandAllNetconf.IsNull() && data.MgmtInbandAllNetconf.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "management-plane/inband/interfaces/all/allow/netconf"))
	}
	...
	if !state.MgmtInbandAllXml.IsNull() && data.MgmtInbandAllXml.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "management-plane/inband/interfaces/all/allow/xr-xml"))
	}
	...
	if !state.MgmtInbandAllHttp.IsNull() && data.MgmtInbandAllHttp.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "management-plane/inband/interfaces/all/allow/http"))
	}
	...
	if !state.MgmtInbandAllTftp.IsNull() && data.MgmtInbandAllTftp.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "management-plane/inband/interfaces/all/allow/tftp"))
	}
	...
	if !state.MgmtInbandAllSnmp.IsNull() && data.MgmtInbandAllSnmp.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "management-plane/inband/interfaces/all/allow/snmp"))
	}
	...
	if !state.MgmtInbandAllTelnet.IsNull() && data.MgmtInbandAllTelnet.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "management-plane/inband/interfaces/all/allow/telnet"))
	}
	...
	if !state.MgmtInbandAllSsh.IsNull() && data.MgmtInbandAllSsh.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "management-plane/inband/interfaces/all/allow/ssh"))
	}
...
func (data *ControlPlane) getDeletePaths(ctx context.Context, version string) []string {
	...
	if !data.MgmtOobInbandBehavior.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "management-plane/out-of-band/enable-inband-behavior"))
	}
	if !data.MgmtOobVrf.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "management-plane/out-of-band/vrf"))
	}
	for i := range data.MgmtOobInterfaces {
		keys := [...]string{"interface-name"}
		keyValues := [...]string{data.MgmtOobInterfaces[i].InterfaceName.ValueString()}
