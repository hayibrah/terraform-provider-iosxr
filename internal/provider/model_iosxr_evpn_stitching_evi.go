...
func (data EVPNStitchingEVI) GetEnumConstraints() []helpers.FieldEnumConstraint {
	return nil
}
...
func (data EVPNStitchingEVI) GetStringLengthConstraints() []helpers.FieldStringLengthConstraint {
	return nil
}
...
func (data EVPNStitchingEVI) GetPatternConstraints() []helpers.FieldPatternConstraint {
	return nil
}
...
func (data *EVPNStitchingEVI) updateFromBody(ctx context.Context, res []byte, version string) {
...
func (data *EVPNStitchingEVI) fromBody(ctx context.Context, res []byte, version string) {
...
func (data *EVPNStitchingEVIData) fromBody(ctx context.Context, res []byte, version string) {
	if value := gjson.GetBytes(res, "description"); value.Exists() && value.Type == gjson.String {
		data.Description = types.StringValue(value.String())
	}
	if value := gjson.GetBytes(res, "bgp.rd.two-byte-as-number"); value.Exists() && value.Type == gjson.Number {
...
func (data *EVPNStitchingEVI) getDeletedItems(ctx context.Context, state EVPNStitchingEVI, version string) []string {
...
func (data *EVPNStitchingEVI) getEmptyLeafsDelete(ctx context.Context, version string) []string {
...
func (data *EVPNStitchingEVI) getDeletePaths(ctx context.Context, version string) []string {
