...
func (data RouterStaticVRFIPv4Unicast) GetEnumConstraints() []helpers.FieldEnumConstraint {
	return nil
}
...
func (data RouterStaticVRFIPv4Unicast) GetStringLengthConstraints() []helpers.FieldStringLengthConstraint {
	return nil
}
...
func (data RouterStaticVRFIPv4Unicast) GetPatternConstraints() []helpers.FieldPatternConstraint {
	return nil
}
...
func (data *RouterStaticVRFIPv4Unicast) updateFromBody(ctx context.Context, res []byte, version string) {
...
func (data *RouterStaticVRFIPv4Unicast) fromBody(ctx context.Context, res []byte, version string) {
...
func (data *RouterStaticVRFIPv4UnicastData) fromBody(ctx context.Context, res []byte, version string) {
	if value := gjson.GetBytes(res, "nexthop-interfaces.nexthop-interface"); value.Exists() {
		data.NexthopInterfaces = make([]RouterStaticVRFIPv4UnicastNexthopInterfaces, 0)
		value.ForEach(func(k, v gjson.Result) bool {
			item := RouterStaticVRFIPv4UnicastNexthopInterfaces{}
...
func (data *RouterStaticVRFIPv4Unicast) getDeletedItems(ctx context.Context, state RouterStaticVRFIPv4Unicast, version string) []string {
...
func (data *RouterStaticVRFIPv4Unicast) getEmptyLeafsDelete(ctx context.Context, version string) []string {
...
func (data *RouterStaticVRFIPv4Unicast) getDeletePaths(ctx context.Context, version string) []string {
