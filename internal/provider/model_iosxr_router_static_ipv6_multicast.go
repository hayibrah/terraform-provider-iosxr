...
func (data RouterStaticIPv6Multicast) GetStringLengthConstraints() []helpers.FieldStringLengthConstraint {
	return nil
}
...
func (data RouterStaticIPv6Multicast) GetPatternConstraints() []helpers.FieldPatternConstraint {
	return nil
}
...
func (data *RouterStaticIPv6Multicast) fromBody(ctx context.Context, res []byte, version string) {
...
func (data *RouterStaticIPv6MulticastData) fromBody(ctx context.Context, res []byte, version string) {
	if value := gjson.GetBytes(res, "nexthop-interfaces.nexthop-interface"); value.Exists() {
		data.NexthopInterfaces = make([]RouterStaticIPv6MulticastNexthopInterfaces, 0)
		value.ForEach(func(k, v gjson.Result) bool {
			item := RouterStaticIPv6MulticastNexthopInterfaces{}
...
func (data *RouterStaticIPv6Multicast) getDeletedItems(ctx context.Context, state RouterStaticIPv6Multicast, version string) []string {
...
func (data *RouterStaticIPv6Multicast) getEmptyLeafsDelete(ctx context.Context, version string) []string {
...
func (data *RouterStaticIPv6Multicast) getDeletePaths(ctx context.Context, version string) []string {
