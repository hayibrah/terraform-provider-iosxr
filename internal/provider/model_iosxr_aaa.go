...
func (data AAA) GetEnumConstraints() []helpers.FieldEnumConstraint {
	return nil
}
...
func (data AAA) GetStringLengthConstraints() []helpers.FieldStringLengthConstraint {
	return nil
}
...
func (data AAA) GetPatternConstraints() []helpers.FieldPatternConstraint {
	return nil
}
...
func (data *AAA) updateFromBody(ctx context.Context, res []byte, version string) {
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-aaa-task-user-cfg:default-taskgroup"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.DefaultTaskgroup.IsNull() {
		data.DefaultTaskgroup = types.StringValue(value.String())
	} else {
		data.DefaultTaskgroup = types.StringNull()
	}
	if value := gjson.GetBytes(res, "banner.login"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.BannerLogin.IsNull() {
	...
	for i := range data.RadiusServerGroups {
		...
		if value := r.Get("server-group-name"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.RadiusServerGroups[i].GroupName.IsNull() {
		...
		for ci := range data.RadiusServerGroups[i].Servers {
			...
			if value := cr.Get("ordering-index"); value.Exists() && value.Type == gjson.Number && !data.RadiusServerGroups[i].Servers[ci].Order.IsNull() {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.RadiusServerGroups[i].Servers[ci].Address.IsNull() {
			...
			if value := cr.Get("auth-port"); value.Exists() && value.Type == gjson.Number && !data.RadiusServerGroups[i].Servers[ci].AuthPort.IsNull() {
			...
			if value := cr.Get("acct-port"); value.Exists() && value.Type == gjson.Number && !data.RadiusServerGroups[i].Servers[ci].AcctPort.IsNull() {
		...
		if value := r.Get("load-balance.method.least-outstanding.batch-size"); value.Exists() && value.Type == gjson.Number && !data.RadiusServerGroups[i].LoadBalanceMethodLeastOutstandingBatchSize.IsNull() {
		...
		if value := r.Get("deadtime"); value.Exists() && value.Type == gjson.Number && !data.RadiusServerGroups[i].Deadtime.IsNull() {
			data.RadiusServerGroups[i].Deadtime = types.Int64Value(value.Int())
		} else {
			data.RadiusServerGroups[i].Deadtime = types.Int64Null()
		}
		if value := r.Get("throttle.access"); value.Exists() && value.Type == gjson.Number && !data.RadiusServerGroups[i].ThrottleAccess.IsNull() {
		...
		if value := r.Get("throttle.access-timeout"); value.Exists() && value.Type == gjson.Number && !data.RadiusServerGroups[i].ThrottleAccessTimeout.IsNull() {
		...
		if value := r.Get("throttle.accounting"); value.Exists() && value.Type == gjson.Number && !data.RadiusServerGroups[i].ThrottleAccounting.IsNull() {
		...
		for ci := range data.RadiusServerGroups[i].ServerPrivates {
			...
			if value := cr.Get("ordering-index"); value.Exists() && value.Type == gjson.Number && !data.RadiusServerGroups[i].ServerPrivates[ci].Order.IsNull() {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.RadiusServerGroups[i].ServerPrivates[ci].Address.IsNull() {
			...
			if value := cr.Get("auth-port"); value.Exists() && value.Type == gjson.Number && !data.RadiusServerGroups[i].ServerPrivates[ci].AuthPort.IsNull() {
			...
			if value := cr.Get("acct-port"); value.Exists() && value.Type == gjson.Number && !data.RadiusServerGroups[i].ServerPrivates[ci].AcctPort.IsNull() {
			...
			if value := cr.Get("timeout"); value.Exists() && value.Type == gjson.Number && !data.RadiusServerGroups[i].ServerPrivates[ci].Timeout.IsNull() {
			...
			if value := cr.Get("retransmit"); value.Exists() && value.Type == gjson.Number && !data.RadiusServerGroups[i].ServerPrivates[ci].Retransmit.IsNull() {
			...
			if value := cr.Get("test.username"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.RadiusServerGroups[i].ServerPrivates[ci].TestUsername.IsNull() {
			...
			if value := cr.Get("idle-time"); value.Exists() && value.Type == gjson.Number && !data.RadiusServerGroups[i].ServerPrivates[ci].IdleTime.IsNull() {
		...
		if value := r.Get("source-interface"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.RadiusServerGroups[i].SourceInterface.IsNull() {
		...
		if value := r.Get("authorization.request.radius-attribute-list"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.RadiusServerGroups[i].AuthorizationRequestRadiusAttributeList.IsNull() {
		...
		if value := r.Get("authorization.reply.radius-attribute-list"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.RadiusServerGroups[i].AuthorizationReplyRadiusAttributeList.IsNull() {
		...
		if value := r.Get("accounting.request.radius-attribute-list"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.RadiusServerGroups[i].AccountingRequestRadiusAttributeList.IsNull() {
		...
		if value := r.Get("accounting.reply.radius-attribute-list"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.RadiusServerGroups[i].AccountingReplyRadiusAttributeList.IsNull() {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-aaa-radius-server-cfg:server.radius.dynamic-author.port"); value.Exists() && value.Type == gjson.Number && !data.ServerRadiusDynamicAuthorPort.IsNull() {
	...
	for i := range data.ServerRadiusDynamicAuthorClients {
		...
		if value := r.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.ServerRadiusDynamicAuthorClients[i].Address.IsNull() {
		...
		if value := r.Get("vrf"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.ServerRadiusDynamicAuthorClients[i].Vrf.IsNull() {
	...
	for i := range data.TacacsServerGroups {
		...
		if value := r.Get("server-group-name"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.TacacsServerGroups[i].GroupName.IsNull() {
		...
		for ci := range data.TacacsServerGroups[i].Servers {
			...
			if value := cr.Get("ordering-index"); value.Exists() && value.Type == gjson.Number && !data.TacacsServerGroups[i].Servers[ci].Order.IsNull() {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.TacacsServerGroups[i].Servers[ci].Address.IsNull() {
		...
		if value := r.Get("vrf"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.TacacsServerGroups[i].Vrf.IsNull() {
			data.TacacsServerGroups[i].Vrf = types.StringValue(value.String())
		} else {
			data.TacacsServerGroups[i].Vrf = types.StringNull()
		}
		if value := r.Get("holddown-time"); value.Exists() && value.Type == gjson.Number && !data.TacacsServerGroups[i].HolddownTime.IsNull() {
		...
		for ci := range data.TacacsServerGroups[i].ServerPrivates {
			...
			if value := cr.Get("ordering-index"); value.Exists() && value.Type == gjson.Number && !data.TacacsServerGroups[i].ServerPrivates[ci].Order.IsNull() {
			...
			if value := cr.Get("address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.TacacsServerGroups[i].ServerPrivates[ci].Address.IsNull() {
			...
			if value := cr.Get("port"); value.Exists() && value.Type == gjson.Number && !data.TacacsServerGroups[i].ServerPrivates[ci].Port.IsNull() {
			...
			if value := cr.Get("single-connection-idle-timeout"); value.Exists() && value.Type == gjson.Number && !data.TacacsServerGroups[i].ServerPrivates[ci].SingleConnectionIdleTimeout.IsNull() {
			...
			if value := cr.Get("timeout"); value.Exists() && value.Type == gjson.Number && !data.TacacsServerGroups[i].ServerPrivates[ci].Timeout.IsNull() {
			...
			if value := cr.Get("holddown-time"); value.Exists() && value.Type == gjson.Number && !data.TacacsServerGroups[i].ServerPrivates[ci].HolddownTime.IsNull() {
	...
	for i := range data.Usernames {
		...
		if value := r.Get("ordering-index"); value.Exists() && value.Type == gjson.Number && !data.Usernames[i].Order.IsNull() {
			data.Usernames[i].Order = types.Int64Value(value.Int())
		} else {
			data.Usernames[i].Order = types.Int64Null()
		}
		if value := r.Get("name"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.Usernames[i].Name.IsNull() {
		...
		if value := r.Get("policy"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.Usernames[i].Policy.IsNull() {
		...
		for ci := range data.Usernames[i].UserGroups {
			...
			if value := cr.Get("user-group-name"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.Usernames[i].UserGroups[ci].GroupName.IsNull() {
		...
		if value := r.Get("shell-type"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.Usernames[i].ShellType.IsNull() {
			data.Usernames[i].ShellType = types.StringValue(value.String())
		} else {
			data.Usernames[i].ShellType = types.StringNull()
		}
		if value := r.Get("directory"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.Usernames[i].Directory.IsNull() {
	...
	for i := range data.Taskgroups {
		...
		if value := r.Get("taskgroup-name"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.Taskgroups[i].GroupName.IsNull() {
			data.Taskgroups[i].GroupName = types.StringValue(value.String())
		} else {
			data.Taskgroups[i].GroupName = types.StringNull()
		}
		if value := r.Get("description"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.Taskgroups[i].Description.IsNull() {
		...
		for ci := range data.Taskgroups[i].InheritTaskgroups {
			...
			if value := cr.Get("task-group-name"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.Taskgroups[i].InheritTaskgroups[ci].GroupName.IsNull() {
	...
	for i := range data.Usergroups {
		...
		if value := r.Get("usergroup-name"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.Usergroups[i].GroupName.IsNull() {
			data.Usergroups[i].GroupName = types.StringValue(value.String())
		} else {
			data.Usergroups[i].GroupName = types.StringNull()
		}
		if value := r.Get("description"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.Usergroups[i].Description.IsNull() {
		...
		for ci := range data.Usergroups[i].Taskgroups {
			...
			if value := cr.Get("task-group-name"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.Usergroups[i].Taskgroups[ci].GroupName.IsNull() {
		...
		for ci := range data.Usergroups[i].InheritUsergroups {
			...
			if value := cr.Get("usergroup-name"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.Usergroups[i].InheritUsergroups[ci].GroupName.IsNull() {
...
func (data *AAA) fromBody(ctx context.Context, res []byte, version string) {
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-aaa-task-user-cfg:default-taskgroup"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) {
		data.DefaultTaskgroup = types.StringValue(value.String())
	}
	if value := gjson.GetBytes(res, "banner.login"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) {
		data.BannerLogin = types.StringValue(value.String())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-aaa-radius-server-cfg:group.server.radius.server-groups.server-group"); value.Exists() {
		...
		value.ForEach(func(k, v gjson.Result) bool {
			...
			if cValue := v.Get("server-group-name"); cValue.Exists() && (cValue.Type == gjson.String || cValue.Type == gjson.Number) {
			...
			if cValue := v.Get("servers.server"); cValue.Exists() {
				...
				cValue.ForEach(func(ck, cv gjson.Result) bool {
					...
					if ccValue := cv.Get("ordering-index"); ccValue.Exists() && ccValue.Type == gjson.Number {
					...
					if ccValue := cv.Get("auth-port"); ccValue.Exists() && ccValue.Type == gjson.Number {
						cItem.AuthPort = types.Int64Value(ccValue.Int())
					}
					if ccValue := cv.Get("acct-port"); ccValue.Exists() && ccValue.Type == gjson.Number {
			...
			if cValue := v.Get("load-balance.method.least-outstanding.batch-size"); cValue.Exists() && cValue.Type == gjson.Number {
			...
			if cValue := v.Get("deadtime"); cValue.Exists() && cValue.Type == gjson.Number {
				item.Deadtime = types.Int64Value(cValue.Int())
			}
			if cValue := v.Get("throttle.access"); cValue.Exists() && cValue.Type == gjson.Number {
				item.ThrottleAccess = types.Int64Value(cValue.Int())
			}
			if cValue := v.Get("throttle.access-timeout"); cValue.Exists() && cValue.Type == gjson.Number {
				item.ThrottleAccessTimeout = types.Int64Value(cValue.Int())
			}
			if cValue := v.Get("throttle.accounting"); cValue.Exists() && cValue.Type == gjson.Number {
			...
			if cValue := v.Get("server-privates.server-private"); cValue.Exists() {
				...
				cValue.ForEach(func(ck, cv gjson.Result) bool {
					...
					if ccValue := cv.Get("timeout"); ccValue.Exists() && ccValue.Type == gjson.Number {
						cItem.Timeout = types.Int64Value(ccValue.Int())
					}
					if ccValue := cv.Get("retransmit"); ccValue.Exists() && ccValue.Type == gjson.Number {
						cItem.Retransmit = types.Int64Value(ccValue.Int())
					}
					if ccValue := cv.Get("test.username"); ccValue.Exists() && (ccValue.Type == gjson.String || ccValue.Type == gjson.Number) {
						cItem.TestUsername = types.StringValue(ccValue.String())
					}
					if ccValue := cv.Get("idle-time"); ccValue.Exists() && ccValue.Type == gjson.Number {
			...
			if cValue := v.Get("authorization.request.radius-attribute-list"); cValue.Exists() && (cValue.Type == gjson.String || cValue.Type == gjson.Number) {
			...
			if cValue := v.Get("authorization.reply.radius-attribute-list"); cValue.Exists() && (cValue.Type == gjson.String || cValue.Type == gjson.Number) {
			...
			if cValue := v.Get("accounting.request.radius-attribute-list"); cValue.Exists() && (cValue.Type == gjson.String || cValue.Type == gjson.Number) {
			...
			if cValue := v.Get("accounting.reply.radius-attribute-list"); cValue.Exists() && (cValue.Type == gjson.String || cValue.Type == gjson.Number) {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-aaa-radius-server-cfg:server.radius.dynamic-author.port"); value.Exists() && value.Type == gjson.Number {
		data.ServerRadiusDynamicAuthorPort = types.Int64Value(value.Int())
	}
		...
		value.ForEach(func(k, v gjson.Result) bool {
			...
			if cValue := v.Get("server-privates.server-private"); cValue.Exists() {
				...
				cValue.ForEach(func(ck, cv gjson.Result) bool {
					...
					if ccValue := cv.Get("single-connection-idle-timeout"); ccValue.Exists() && ccValue.Type == gjson.Number {
						cItem.SingleConnectionIdleTimeout = types.Int64Value(ccValue.Int())
					}
					if ccValue := cv.Get("timeout"); ccValue.Exists() && ccValue.Type == gjson.Number {
						cItem.Timeout = types.Int64Value(ccValue.Int())
					}
					if ccValue := cv.Get("holddown-time"); ccValue.Exists() && ccValue.Type == gjson.Number {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-aaa-task-user-cfg:usernames.username"); value.Exists() {
		...
		value.ForEach(func(k, v gjson.Result) bool {
			...
			if cValue := v.Get("policy"); cValue.Exists() && (cValue.Type == gjson.String || cValue.Type == gjson.Number) {
			...
			if cValue := v.Get("group.user-groups.user-group"); cValue.Exists() {
				...
				cValue.ForEach(func(ck, cv gjson.Result) bool {
					...
					if ccValue := cv.Get("user-group-name"); ccValue.Exists() && (ccValue.Type == gjson.String || ccValue.Type == gjson.Number) {
			...
			if cValue := v.Get("shell-type"); cValue.Exists() && (cValue.Type == gjson.String || cValue.Type == gjson.Number) {
				item.ShellType = types.StringValue(cValue.String())
			}
			if cValue := v.Get("directory"); cValue.Exists() && (cValue.Type == gjson.String || cValue.Type == gjson.Number) {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-aaa-task-user-cfg:taskgroups.taskgroup"); value.Exists() {
		...
		value.ForEach(func(k, v gjson.Result) bool {
			item := AAATaskgroups{}
			if cValue := v.Get("taskgroup-name"); cValue.Exists() && (cValue.Type == gjson.String || cValue.Type == gjson.Number) {
				item.GroupName = types.StringValue(cValue.String())
			}
			...
			if cValue := v.Get("inherit.taskgroup.task-groups.task-group"); cValue.Exists() {
				...
				cValue.ForEach(func(ck, cv gjson.Result) bool {
					...
					if ccValue := cv.Get("task-group-name"); ccValue.Exists() && (ccValue.Type == gjson.String || ccValue.Type == gjson.Number) {
						cItem.GroupName = types.StringValue(ccValue.String())
					}
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-aaa-task-user-cfg:usergroups.usergroup"); value.Exists() {
		...
		value.ForEach(func(k, v gjson.Result) bool {
			item := AAAUsergroups{}
			if cValue := v.Get("usergroup-name"); cValue.Exists() && (cValue.Type == gjson.String || cValue.Type == gjson.Number) {
				item.GroupName = types.StringValue(cValue.String())
			}
			if cValue := v.Get("description"); cValue.Exists() && (cValue.Type == gjson.String || cValue.Type == gjson.Number) {
				item.Description = types.StringValue(cValue.String())
			...
			if cValue := v.Get("inherit.usergroup"); cValue.Exists() {
				...
				cValue.ForEach(func(ck, cv gjson.Result) bool {
					...
					if ccValue := cv.Get("usergroup-name"); ccValue.Exists() && (ccValue.Type == gjson.String || ccValue.Type == gjson.Number) {
						cItem.GroupName = types.StringValue(ccValue.String())
					}
...
func (data *AAA) getDeletedItems(ctx context.Context, state AAA, version string) []string {
	...
	if !state.ServerRadiusDynamicAuthorServerKeyType6.IsNull() && data.ServerRadiusDynamicAuthorServerKeyType6.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "Cisco-IOS-XR-um-aaa-radius-server-cfg:server/radius/dynamic-author/server-key/six"))
	}
	if !state.ServerRadiusDynamicAuthorServerKeyType7.IsNull() && data.ServerRadiusDynamicAuthorServerKeyType7.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "Cisco-IOS-XR-um-aaa-radius-server-cfg:server/radius/dynamic-author/server-key/seven"))
	}
	if !state.ServerRadiusDynamicAuthorIgnoreServerKey.IsNull() && data.ServerRadiusDynamicAuthorIgnoreServerKey.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "Cisco-IOS-XR-um-aaa-radius-server-cfg:server/radius/dynamic-author/ignore/server-key"))
	}
	if !state.ServerRadiusDynamicAuthorPort.IsNull() && data.ServerRadiusDynamicAuthorPort.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "Cisco-IOS-XR-um-aaa-radius-server-cfg:server/radius/dynamic-author/port"))
	}
	...
	if !state.BannerLogin.IsNull() && data.BannerLogin.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "banner/login"))
	}
	if !state.DefaultTaskgroup.IsNull() && data.DefaultTaskgroup.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "Cisco-IOS-XR-um-aaa-task-user-cfg:default-taskgroup"))
	}
	return deletedItems
}
...
func (data *AAA) getDeletePaths(ctx context.Context, version string) []string {
	...
	if !data.ServerRadiusDynamicAuthorServerKeyType7.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "Cisco-IOS-XR-um-aaa-radius-server-cfg:server/radius/dynamic-author/server-key/seven"))
	}
	if !data.ServerRadiusDynamicAuthorIgnoreServerKey.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "Cisco-IOS-XR-um-aaa-radius-server-cfg:server/radius/dynamic-author/ignore/server-key"))
	}
	if !data.ServerRadiusDynamicAuthorPort.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "Cisco-IOS-XR-um-aaa-radius-server-cfg:server/radius/dynamic-author/port"))
	}
	for i := range data.RadiusServerGroups {
		keys := [...]string{"server-group-name"}
		keyValues := [...]string{data.RadiusServerGroups[i].GroupName.ValueString()}
	...
	if !data.DefaultTaskgroup.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "Cisco-IOS-XR-um-aaa-task-user-cfg:default-taskgroup"))
	}
	return deletePaths
}
