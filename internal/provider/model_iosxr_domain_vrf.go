...
func (data DomainVRF) GetEnumConstraints() []helpers.FieldEnumConstraint {
	return nil
}
...
func (data DomainVRF) GetStringLengthConstraints() []helpers.FieldStringLengthConstraint {
	return nil
}
...
func (data DomainVRF) GetPatternConstraints() []helpers.FieldPatternConstraint {
	return nil
}
