...
func (data RouterMLDInterface) GetEnumConstraints() []helpers.FieldEnumConstraint {
	return nil
}
...
func (data RouterMLDInterface) GetStringLengthConstraints() []helpers.FieldStringLengthConstraint {
	return nil
}
...
func (data RouterMLDInterface) GetPatternConstraints() []helpers.FieldPatternConstraint {
	return nil
}
...
func (data *RouterMLDInterface) updateFromBody(ctx context.Context, res []byte, version string) {
...
func (data *RouterMLDInterface) fromBody(ctx context.Context, res []byte, version string) {
...
func (data *RouterMLDInterfaceData) fromBody(ctx context.Context, res []byte, version string) {
	if value := gjson.GetBytes(res, "version"); value.Exists() && value.Type == gjson.Number {
		data.Version = types.Int64Value(value.Int())
	}
	if value := gjson.GetBytes(res, "router.enable"); value.Exists() {
...
func (data *RouterMLDInterface) getDeletedItems(ctx context.Context, state RouterMLDInterface, version string) []string {
...
func (data *RouterMLDInterface) getEmptyLeafsDelete(ctx context.Context, version string) []string {
...
func (data *RouterMLDInterface) getDeletePaths(ctx context.Context, version string) []string {
