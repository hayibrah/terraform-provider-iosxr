...
func (data ClassMapQoS) GetEnumConstraints() []helpers.FieldEnumConstraint {
	return nil
}
...
func (data ClassMapQoS) GetStringLengthConstraints() []helpers.FieldStringLengthConstraint {
	return nil
}
...
func (data ClassMapQoS) GetPatternConstraints() []helpers.FieldPatternConstraint {
	return nil
}
...
func (data *ClassMapQoS) getDeletedItems(ctx context.Context, state ClassMapQoS, version string) []string {
	...
	if !state.MatchTrafficClass.IsNull() && data.MatchTrafficClass.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "match/traffic-class/id"))
	}
	...
	if !state.MatchQosGroup.IsNull() && data.MatchQosGroup.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "match/qos-group/id"))
	}
	...
	if !state.MatchDiscardClass.IsNull() && data.MatchDiscardClass.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "match/discard-class/id"))
	}
...
func (data *ClassMapQoS) getDeletePaths(ctx context.Context, version string) []string {
	...
	if !data.MatchTrafficClass.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "match/traffic-class/id"))
	}
	...
	if !data.MatchDiscardClass.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "match/discard-class/id"))
	}
