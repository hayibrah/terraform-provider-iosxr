...
func (data *InterfaceBundleEther) updateFromBody(ctx context.Context, res []byte, version string) {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-bundle-cfg:bundle.minimum-active.links"); value.Exists() && value.Type == gjson.Number && !data.BundleMinimumActiveLinks.IsNull() {
		data.BundleMinimumActiveLinks = types.Int64Value(value.Int())
	} else {
		data.BundleMinimumActiveLinks = types.Int64Null()
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-bundle-cfg:bundle.maximum-active.links.maximum-number"); value.Exists() && value.Type == gjson.Number && !data.BundleMaximumActiveLinks.IsNull() {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-bundle-cfg:bundle.lacp-delay"); value.Exists() && value.Type == gjson.Number && !data.BundleLacpDelay.IsNull() {
		data.BundleLacpDelay = types.Int64Value(value.Int())
	} else {
		data.BundleLacpDelay = types.Int64Null()
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-bundle-cfg:bundle.lacp-fallback.timeout"); value.Exists() && value.Type == gjson.Number && !data.BundleLacpFallbackTimeout.IsNull() {
		data.BundleLacpFallbackTimeout = types.Int64Value(value.Int())
	} else {
		data.BundleLacpFallbackTimeout = types.Int64Null()
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-bundle-cfg:lacp.switchover.suppress-flaps"); value.Exists() && value.Type == gjson.Number && !data.LacpSwitchoverSuppressFlaps.IsNull() {
		data.LacpSwitchoverSuppressFlaps = types.Int64Value(value.Int())
	} else {
		data.LacpSwitchoverSuppressFlaps = types.Int64Null()
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-bundle-cfg:lacp.churn.logging"); value.Exists() && value.Type == gjson.String && !data.LacpChurnLogging.IsNull() {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-bundle-cfg:lacp.mode"); value.Exists() && value.Type == gjson.String && !data.LacpMode.IsNull() {
		data.LacpMode = types.StringValue(value.String())
	} else {
		data.LacpMode = types.StringNull()
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-bundle-cfg:lacp.system.priority"); value.Exists() && value.Type == gjson.Number && !data.LacpSystemPriority.IsNull() {
		data.LacpSystemPriority = types.Int64Value(value.Int())
	} else {
		data.LacpSystemPriority = types.Int64Null()
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-bundle-cfg:lacp.system.mac"); value.Exists() && value.Type == gjson.String && !data.LacpSystemMac.IsNull() {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-bundle-cfg:bfd.address-family.ipv4.destination"); value.Exists() && value.Type == gjson.String && !data.BfdAddressFamilyIpv4Destination.IsNull() {
		data.BfdAddressFamilyIpv4Destination = types.StringValue(value.String())
	} else {
		data.BfdAddressFamilyIpv4Destination = types.StringNull()
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-bundle-cfg:bfd.address-family.ipv4.minimum-interval"); value.Exists() && value.Type == gjson.Number && !data.BfdAddressFamilyIpv4MinimumInterval.IsNull() {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-bundle-cfg:bfd.address-family.ipv4.multiplier"); value.Exists() && value.Type == gjson.Number && !data.BfdAddressFamilyIpv4Multiplier.IsNull() {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-bundle-cfg:bfd.address-family.ipv4.echo.minimum-interval"); value.Exists() && value.Type == gjson.Number && !data.BfdAddressFamilyIpv4EchoMinimumInterval.IsNull() {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-bundle-cfg:bfd.address-family.ipv4.timers.start"); value.Exists() && value.Type == gjson.Number && !data.BfdAddressFamilyIpv4TimersStart.IsNull() {
		data.BfdAddressFamilyIpv4TimersStart = types.Int64Value(value.Int())
	} else {
		data.BfdAddressFamilyIpv4TimersStart = types.Int64Null()
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-bundle-cfg:bfd.address-family.ipv4.timers.nbr-unconfig"); value.Exists() && value.Type == gjson.Number && !data.BfdAddressFamilyIpv4TimersNbrUnconfig.IsNull() {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-bundle-cfg:bfd.address-family.ipv6.destination"); value.Exists() && value.Type == gjson.String && !data.BfdAddressFamilyIpv6Destination.IsNull() {
		data.BfdAddressFamilyIpv6Destination = types.StringValue(value.String())
	} else {
		data.BfdAddressFamilyIpv6Destination = types.StringNull()
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-bundle-cfg:bfd.address-family.ipv6.minimum-interval"); value.Exists() && value.Type == gjson.Number && !data.BfdAddressFamilyIpv6MinimumInterval.IsNull() {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-bundle-cfg:bfd.address-family.ipv6.multiplier"); value.Exists() && value.Type == gjson.Number && !data.BfdAddressFamilyIpv6Multiplier.IsNull() {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-bundle-cfg:bfd.address-family.ipv6.timers.start"); value.Exists() && value.Type == gjson.Number && !data.BfdAddressFamilyIpv6TimersStart.IsNull() {
		data.BfdAddressFamilyIpv6TimersStart = types.Int64Value(value.Int())
	} else {
		data.BfdAddressFamilyIpv6TimersStart = types.Int64Null()
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-bundle-cfg:bfd.address-family.ipv6.timers.nbr-unconfig"); value.Exists() && value.Type == gjson.Number && !data.BfdAddressFamilyIpv6TimersNbrUnconfig.IsNull() {
...
func (data *InterfaceBundleEther) fromBody(ctx context.Context, res []byte, version string) {
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-bundle-cfg:bundle.minimum-active.links"); value.Exists() && value.Type == gjson.Number {
		data.BundleMinimumActiveLinks = types.Int64Value(value.Int())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-bundle-cfg:bundle.maximum-active.links.maximum-number"); value.Exists() && value.Type == gjson.Number {
		data.BundleMaximumActiveLinks = types.Int64Value(value.Int())
	}
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-bundle-cfg:bundle.lacp-delay"); value.Exists() && value.Type == gjson.Number {
		data.BundleLacpDelay = types.Int64Value(value.Int())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-bundle-cfg:bundle.lacp-fallback.timeout"); value.Exists() && value.Type == gjson.Number {
		data.BundleLacpFallbackTimeout = types.Int64Value(value.Int())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-bundle-cfg:lacp.switchover.suppress-flaps"); value.Exists() && value.Type == gjson.Number {
		data.LacpSwitchoverSuppressFlaps = types.Int64Value(value.Int())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-bundle-cfg:lacp.churn.logging"); value.Exists() && value.Type == gjson.String {
		data.LacpChurnLogging = types.StringValue(value.String())
	}
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-bundle-cfg:lacp.mode"); value.Exists() && value.Type == gjson.String {
		data.LacpMode = types.StringValue(value.String())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-bundle-cfg:lacp.system.priority"); value.Exists() && value.Type == gjson.Number {
		data.LacpSystemPriority = types.Int64Value(value.Int())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-bundle-cfg:lacp.system.mac"); value.Exists() && value.Type == gjson.String {
		data.LacpSystemMac = types.StringValue(value.String())
	}
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-bundle-cfg:bfd.address-family.ipv4.destination"); value.Exists() && value.Type == gjson.String {
		data.BfdAddressFamilyIpv4Destination = types.StringValue(value.String())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-bundle-cfg:bfd.address-family.ipv4.minimum-interval"); value.Exists() && value.Type == gjson.Number {
		data.BfdAddressFamilyIpv4MinimumInterval = types.Int64Value(value.Int())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-bundle-cfg:bfd.address-family.ipv4.multiplier"); value.Exists() && value.Type == gjson.Number {
		data.BfdAddressFamilyIpv4Multiplier = types.Int64Value(value.Int())
	}
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-bundle-cfg:bfd.address-family.ipv4.echo.minimum-interval"); value.Exists() && value.Type == gjson.Number {
		data.BfdAddressFamilyIpv4EchoMinimumInterval = types.Int64Value(value.Int())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-bundle-cfg:bfd.address-family.ipv4.timers.start"); value.Exists() && value.Type == gjson.Number {
		data.BfdAddressFamilyIpv4TimersStart = types.Int64Value(value.Int())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-bundle-cfg:bfd.address-family.ipv4.timers.nbr-unconfig"); value.Exists() && value.Type == gjson.Number {
		data.BfdAddressFamilyIpv4TimersNbrUnconfig = types.Int64Value(value.Int())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-bundle-cfg:bfd.address-family.ipv6.destination"); value.Exists() && value.Type == gjson.String {
		data.BfdAddressFamilyIpv6Destination = types.StringValue(value.String())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-bundle-cfg:bfd.address-family.ipv6.minimum-interval"); value.Exists() && value.Type == gjson.Number {
		data.BfdAddressFamilyIpv6MinimumInterval = types.Int64Value(value.Int())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-bundle-cfg:bfd.address-family.ipv6.multiplier"); value.Exists() && value.Type == gjson.Number {
		data.BfdAddressFamilyIpv6Multiplier = types.Int64Value(value.Int())
	}
	...
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-bundle-cfg:bfd.address-family.ipv6.timers.start"); value.Exists() && value.Type == gjson.Number {
		data.BfdAddressFamilyIpv6TimersStart = types.Int64Value(value.Int())
	}
	if value := gjson.GetBytes(res, "Cisco-IOS-XR-um-if-bundle-cfg:bfd.address-family.ipv6.timers.nbr-unconfig"); value.Exists() && value.Type == gjson.Number {
		data.BfdAddressFamilyIpv6TimersNbrUnconfig = types.Int64Value(value.Int())
	}
...
func (data *InterfaceBundleEther) getEmptyLeafsDelete(ctx context.Context, version string) []string {
