...
func (data RouterHSRPInterfaceIPv4GroupV2) GetEnumConstraints() []helpers.FieldEnumConstraint {
	return nil
}
...
func (data RouterHSRPInterfaceIPv4GroupV2) GetStringLengthConstraints() []helpers.FieldStringLengthConstraint {
	return nil
}
...
func (data RouterHSRPInterfaceIPv4GroupV2) GetPatternConstraints() []helpers.FieldPatternConstraint {
	return nil
}
...
func (data *RouterHSRPInterfaceIPv4GroupV2) updateFromBody(ctx context.Context, res []byte, version string) {
	if value := gjson.GetBytes(res, "address.ipv4-address"); value.Exists() && value.Type == gjson.String && !data.Address.IsNull() {
	...
	for i := range data.SecondaryIpv4Addresses {
		...
		if value := r.Get("address"); value.Exists() && value.Type == gjson.String && !data.SecondaryIpv4Addresses[i].Address.IsNull() {
...
func (data *RouterHSRPInterfaceIPv4GroupV2) fromBody(ctx context.Context, res []byte, version string) {
	if value := gjson.GetBytes(res, "address.ipv4-address"); value.Exists() && value.Type == gjson.String {
		data.Address = types.StringValue(value.String())
	}
...
func (data *RouterHSRPInterfaceIPv4GroupV2Data) fromBody(ctx context.Context, res []byte, version string) {
	if value := gjson.GetBytes(res, "address.ipv4-address"); value.Exists() && value.Type == gjson.String {
		data.Address = types.StringValue(value.String())
	}
	if value := gjson.GetBytes(res, "address.learn"); value.Exists() {
...
func (data *RouterHSRPInterfaceIPv4GroupV2) getDeletedItems(ctx context.Context, state RouterHSRPInterfaceIPv4GroupV2, version string) []string {
...
func (data *RouterHSRPInterfaceIPv4GroupV2) getEmptyLeafsDelete(ctx context.Context, version string) []string {
...
func (data *RouterHSRPInterfaceIPv4GroupV2) getDeletePaths(ctx context.Context, version string) []string {
