...
func (data PolicyGlobalSet) GetEnumConstraints() []helpers.FieldEnumConstraint {
	return nil
}
...
func (data PolicyGlobalSet) GetStringLengthConstraints() []helpers.FieldStringLengthConstraint {
	return nil
}
...
func (data PolicyGlobalSet) GetPatternConstraints() []helpers.FieldPatternConstraint {
	return nil
}
