...
func (data RouterBGPNeighborGroup) GetEnumConstraints() []helpers.FieldEnumConstraint {
	return nil
}
...
func (data RouterBGPNeighborGroup) GetStringLengthConstraints() []helpers.FieldStringLengthConstraint {
	return nil
}
...
func (data RouterBGPNeighborGroup) GetPatternConstraints() []helpers.FieldPatternConstraint {
	return nil
}
...
func (data *RouterBGPNeighborGroup) updateFromBody(ctx context.Context, res []byte, version string) {
	...
	if value := gjson.GetBytes(res, "use.neighbor-group"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.UseNeighborGroup.IsNull() {
	...
	if value := gjson.GetBytes(res, "update.in.filtering.message.buffers.buffer-list"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.UpdateInFilteringMessageBuffersType.IsNull() {
	...
	if value := gjson.GetBytes(res, "update.in.filtering.attribute-filter.group"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.UpdateInFilteringAttributeFilterGroup.IsNull() {
	...
	for i := range data.AddressFamily {
		...
		if value := r.Get("encapsulation-type"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.AddressFamily[i].EncapsulationType.IsNull() {
		...
		if value := r.Get("use.af-group"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.AddressFamily[i].UseAfGroup.IsNull() {
			data.AddressFamily[i].UseAfGroup = types.StringValue(value.String())
		} else {
			data.AddressFamily[i].UseAfGroup = types.StringNull()
		}
		if value := r.Get("capability.orf.prefix.capability-receive-orf-neighbor"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.AddressFamily[i].CapabilityOrfPrefix.IsNull() {
		...
		if value := r.Get("default-originate.route-policy"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.AddressFamily[i].DefaultOriginateRoutePolicy.IsNull() {
		...
		if value := r.Get("route-policy.in"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.AddressFamily[i].RoutePolicyIn.IsNull() {
			data.AddressFamily[i].RoutePolicyIn = types.StringValue(value.String())
		} else {
			data.AddressFamily[i].RoutePolicyIn = types.StringNull()
		}
		if value := r.Get("route-policy.out"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.AddressFamily[i].RoutePolicyOut.IsNull() {
			data.AddressFamily[i].RoutePolicyOut = types.StringValue(value.String())
		} else {
			data.AddressFamily[i].RoutePolicyOut = types.StringNull()
		}
		if value := r.Get("orf.route-policy"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.AddressFamily[i].OrfRoutePolicy.IsNull() {
		...
		if value := r.Get("site-of-origin.two-byte-as.two-byte-as-number"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.AddressFamily[i].SiteOfOriginTwoByteAsNumber.IsNull() {
		...
		if value := r.Get("site-of-origin.four-byte-as.four-byte-as-number"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.AddressFamily[i].SiteOfOriginFourByteAsNumber.IsNull() {
		...
		if value := r.Get("site-of-origin.ipv4-address.address"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.AddressFamily[i].SiteOfOriginIpv4Address.IsNull() {
		...
		if value := r.Get("default-policy-action.in"); helpers.VersionAtLeast(version, "25.4") && value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.AddressFamily[i].DefaultPolicyActionIn.IsNull() {
		...
		if value := r.Get("default-policy-action.out"); helpers.VersionAtLeast(version, "25.4") && value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) && !data.AddressFamily[i].DefaultPolicyActionOut.IsNull() {
...
func (data *RouterBGPNeighborGroup) fromBody(ctx context.Context, res []byte, version string) {
	...
	if value := gjson.GetBytes(res, "use.neighbor-group"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) {
		data.UseNeighborGroup = types.StringValue(value.String())
	}
	...
	if value := gjson.GetBytes(res, "update.in.filtering.attribute-filter.group"); value.Exists() && (value.Type == gjson.String || value.Type == gjson.Number) {
		data.UpdateInFilteringAttributeFilterGroup = types.StringValue(value.String())
	}
	...
	if value := gjson.GetBytes(res, "address-families.address-family"); value.Exists() {
		...
		value.ForEach(func(k, v gjson.Result) bool {
			...
			if cValue := v.Get("use.af-group"); cValue.Exists() && (cValue.Type == gjson.String || cValue.Type == gjson.Number) {
				item.UseAfGroup = types.StringValue(cValue.String())
			}
			if cValue := v.Get("capability.orf.prefix.capability-receive-orf-neighbor"); cValue.Exists() && (cValue.Type == gjson.String || cValue.Type == gjson.Number) {
			...
			if cValue := v.Get("default-originate.route-policy"); cValue.Exists() && (cValue.Type == gjson.String || cValue.Type == gjson.Number) {
			...
			if cValue := v.Get("route-policy.in"); cValue.Exists() && (cValue.Type == gjson.String || cValue.Type == gjson.Number) {
				item.RoutePolicyIn = types.StringValue(cValue.String())
			}
			if cValue := v.Get("route-policy.out"); cValue.Exists() && (cValue.Type == gjson.String || cValue.Type == gjson.Number) {
				item.RoutePolicyOut = types.StringValue(cValue.String())
			}
			if cValue := v.Get("orf.route-policy"); cValue.Exists() && (cValue.Type == gjson.String || cValue.Type == gjson.Number) {
...
func (data *RouterBGPNeighborGroup) getDeletedItems(ctx context.Context, state RouterBGPNeighborGroup, version string) []string {
	...
	if !state.GracefulMaintenanceBandwidthAwareInheritanceDisable.IsNull() && data.GracefulMaintenanceBandwidthAwareInheritanceDisable.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "graceful-maintenance/bandwidth-aware"))
	}
	if !state.GracefulMaintenanceBandwidthAwareBandwidthThresholdHigh.IsNull() && data.GracefulMaintenanceBandwidthAwareBandwidthThresholdHigh.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "graceful-maintenance/bandwidth-aware/bandwidth/bandwidth-threshold"))
	}
	...
	if !state.GracefulMaintenanceBandwidthAwarePercentageThresholdHigh.IsNull() && data.GracefulMaintenanceBandwidthAwarePercentageThresholdHigh.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "graceful-maintenance/bandwidth-aware/bandwidth/percentage-threshold"))
	}
	...
	if !state.GracefulMaintenanceAsPrependsInheritanceDisable.IsNull() && data.GracefulMaintenanceAsPrependsInheritanceDisable.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "graceful-maintenance/as-prepends"))
	}
	...
	if !state.GracefulMaintenanceLocalPreferenceInheritanceDisable.IsNull() && data.GracefulMaintenanceLocalPreferenceInheritanceDisable.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "graceful-maintenance/local-preference"))
	}
	...
	if !state.GracefulMaintenanceActivateInheritanceDisable.IsNull() && data.GracefulMaintenanceActivateInheritanceDisable.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "graceful-maintenance/activate/inheritance-disable"))
	}
	if !state.GracefulMaintenanceActivate.IsNull() && data.GracefulMaintenanceActivate.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "graceful-maintenance/activate"))
	}
	...
	if !state.UpdateInFilteringAttributeFilterGroup.IsNull() && data.UpdateInFilteringAttributeFilterGroup.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "update/in/filtering/attribute-filter/group"))
	}
	if !state.UpdateInFilteringLoggingDisable.IsNull() && data.UpdateInFilteringLoggingDisable.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "update/in/filtering/logging/disable"))
	}
	if !state.UpdateInFilteringMessageBuffersType.IsNull() && data.UpdateInFilteringMessageBuffersType.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "update/in/filtering/message/buffers"))
	}
	...
	if !state.UseNeighborGroup.IsNull() && data.UseNeighborGroup.IsNull() {
		deletedItems = append(deletedItems, path.Join(state.getPath(), "use/neighbor-group"))
	}
...
func (data *RouterBGPNeighborGroup) getDeletePaths(ctx context.Context, version string) []string {
	...
	if !data.GracefulMaintenanceBandwidthAwareBandwidthThresholdHigh.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "graceful-maintenance/bandwidth-aware/bandwidth/bandwidth-threshold"))
	}
	...
	if !data.GracefulMaintenanceBandwidthAwarePercentageThresholdHigh.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "graceful-maintenance/bandwidth-aware/bandwidth/percentage-threshold"))
	}
	...
	if !data.GracefulMaintenanceAsPrependsInheritanceDisable.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "graceful-maintenance/as-prepends"))
	}
	if !data.GracefulMaintenanceAsPrependsNumber.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "graceful-maintenance/as-prepends"))
	}
	if !data.GracefulMaintenanceLocalPreferenceInheritanceDisable.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "graceful-maintenance/local-preference"))
	}
	if !data.GracefulMaintenanceLocalPreference.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "graceful-maintenance/local-preference"))
	}
	if !data.GracefulMaintenanceActivateInheritanceDisable.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "graceful-maintenance/activate/inheritance-disable"))
	}
	if !data.GracefulMaintenanceActivate.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "graceful-maintenance/activate"))
	}
	...
	if !data.UpdateInFilteringAttributeFilterGroup.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "update/in/filtering/attribute-filter/group"))
	}
	if !data.UpdateInFilteringLoggingDisable.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "update/in/filtering/logging/disable"))
	}
	if !data.UpdateInFilteringMessageBuffersType.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "update/in/filtering/message/buffers"))
	}
	...
	if !data.UseNeighborGroup.IsNull() {
		deletePaths = append(deletePaths, path.Join(data.getPath(), "use/neighbor-group"))
	}
