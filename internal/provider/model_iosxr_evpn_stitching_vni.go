...
func (data EVPNStitchingVNI) GetEnumConstraints() []helpers.FieldEnumConstraint {
	return nil
}
...
func (data EVPNStitchingVNI) GetStringLengthConstraints() []helpers.FieldStringLengthConstraint {
	return nil
}
...
func (data EVPNStitchingVNI) GetPatternConstraints() []helpers.FieldPatternConstraint {
	return nil
}
...
func (data *EVPNStitchingVNI) getDeletedItems(ctx context.Context, state EVPNStitchingVNI, version string) []string {
...
func (data *EVPNStitchingVNI) getEmptyLeafsDelete(ctx context.Context, version string) []string {
...
func (data *EVPNStitchingVNI) getDeletePaths(ctx context.Context, version string) []string {
