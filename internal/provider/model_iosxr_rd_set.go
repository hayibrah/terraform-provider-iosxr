...
func (data RDSet) GetEnumConstraints() []helpers.FieldEnumConstraint {
	return nil
}
...
func (data RDSet) GetStringLengthConstraints() []helpers.FieldStringLengthConstraint {
	return nil
}
...
func (data RDSet) GetPatternConstraints() []helpers.FieldPatternConstraint {
	return nil
}
...
func (data *RDSet) getEmptyLeafsDelete(ctx context.Context, version string) []string {
