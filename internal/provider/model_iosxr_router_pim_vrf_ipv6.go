...
func (data RouterPIMVRFIPv6) GetEnumConstraints() []helpers.FieldEnumConstraint {
	return nil
}
...
func (data RouterPIMVRFIPv6) GetStringLengthConstraints() []helpers.FieldStringLengthConstraint {
	return nil
}
...
func (data RouterPIMVRFIPv6) GetPatternConstraints() []helpers.FieldPatternConstraint {
	return nil
}
