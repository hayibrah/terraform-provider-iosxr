...
func (data L2VPNPWClass) GetEnumConstraints() []helpers.FieldEnumConstraint {
	return nil
}
...
func (data L2VPNPWClass) GetStringLengthConstraints() []helpers.FieldStringLengthConstraint {
	return nil
}
...
func (data L2VPNPWClass) GetPatternConstraints() []helpers.FieldPatternConstraint {
	return nil
}
