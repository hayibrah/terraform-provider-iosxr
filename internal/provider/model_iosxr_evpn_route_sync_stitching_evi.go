...
func (data EVPNRouteSyncStitchingEVI) GetEnumConstraints() []helpers.FieldEnumConstraint {
	return nil
}
...
func (data EVPNRouteSyncStitchingEVI) GetStringLengthConstraints() []helpers.FieldStringLengthConstraint {
	return nil
}
...
func (data EVPNRouteSyncStitchingEVI) GetPatternConstraints() []helpers.FieldPatternConstraint {
	return nil
}
...
func (data *EVPNRouteSyncStitchingEVI) updateFromBody(ctx context.Context, res []byte, version string) {
...
func (data *EVPNRouteSyncStitchingEVI) fromBody(ctx context.Context, res []byte, version string) {
...
func (data *EVPNRouteSyncStitchingEVIData) fromBody(ctx context.Context, res []byte, version string) {
	if value := gjson.GetBytes(res, "description"); value.Exists() && value.Type == gjson.String {
		data.Description = types.StringValue(value.String())
	}
	if value := gjson.GetBytes(res, "bgp.rd.two-byte-as-number"); value.Exists() && value.Type == gjson.Number {
...
func (data *EVPNRouteSyncStitchingEVI) getDeletedItems(ctx context.Context, state EVPNRouteSyncStitchingEVI, version string) []string {
...
func (data *EVPNRouteSyncStitchingEVI) getEmptyLeafsDelete(ctx context.Context, version string) []string {
...
func (data *EVPNRouteSyncStitchingEVI) getDeletePaths(ctx context.Context, version string) []string {
